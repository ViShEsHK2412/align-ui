...
`,mn=[{name:"rulers",label:"R",title:"rulers down the top and left edges",toggle:!0},{name:"xray",label:"X",title:"outline every element on the page",toggle:!0},{name:"grid",label:"G",title:"your column grid, if one is configured",toggle:!0},{name:"pixels",label:"K",title:"a ten-pixel texture to read against",toggle:!0},{name:"type",label:"T",title:"type and token readout",toggle:!0},{name:"panel",label:"B",title:"the box model panel",toggle:!0},{name:"freeze",label:"F",title:"hold the page still",toggle:!0},{name:"copy",label:"C",title:"copy the numbers in the panel",toggle:!1},{name:"pick",label:"P",title:"pick a colour from anywhere on screen",toggle:!1},{name:"undo",label:"\u21BA",title:"undo the last change to the guides",toggle:!1}];function fn(e,t){let o=document.createElement("style");o.textContent=yo,e.appendChild(o);let n=document.createElement("div");n.className="flag";let r=document.createElement("span");r.className="name",r.textContent="Align";let i=document.createElement("span");i.className="count";let a=new Map,l=document.createElement("div");l.className="tools";for(let d of mn){if(d.name==="freeze"||d.name==="copy"){let u=document.createElement("span");u.className="sep",l.appendChild(u)}let g=document.createElement("button");g.type="button",g.className="tool",g.textContent=d.label,g.title=`${d.title}  \xB7  ${d.name==="undo"?"Ctrl/Cmd+Z":d.label}`,d.toggle||g.setAttribute("data-once",""),g.addEventListener("click",u=>{u.stopPropagation(),t(d.name)}),a.set(d.name,g),l.appendChild(g)}n.append(r,l,i);let c=document.createElement("div");c.className="help";let x=document.createElement("dl");for(let[d,g]of xo){let u=document.createElement("dt"),y=document.createElement("kbd");y.textContent=d,u.appendChild(y);let S=document.createElement("dd");S.textContent=g,x.append(u,S)}return c.appendChild(x),n.addEventListener("click",d=>{d.stopPropagation(),c.toggleAttribute("data-open")}),e.append(n,c),{update(d,g){i.textContent=d>0?`${d} locked`:"",n.toggleAttribute("data-rulers",g.rulers),c.toggleAttribute("data-rulers",g.rulers);for(let u of mn)u.toggle&&a.get(u.name)?.toggleAttribute("data-on",g[u.name]===!0)},closeHelp(){let d=c.hasAttribute("data-open");return c.removeAttribute("data-open"),d},destroy(){n.remove(),c.remove(),o.remove()}}}var He=5,ct=4,Me=12,hn=.22,ve=10,bo=50,vo=100;function gn(){let e=document.createElement("div");e.id="__align_host",e.setAttribute("data-align-ignore",""),e.style.cssText="all: initial; position: fixed; inset: 0; z-index: 2147483647; pointer-events: none;",document.documentElement.appendChild(e);let t=e.attachShadow({mode:"closed"}),o=document.createElement("canvas");o.style.cssText="position: fixed; inset: 0; pointer-events: none;",t.appendChild(o);let n=o.getContext("2d"),r={hover:null,pinned:[],lines:[],cursor:null,rulers:!1,grid:null,pixels:!1,guides:[],liveGuide:null,activeGuide:null},i=it(at()),a=0,l=null;function c(){let s=at();s!==l&&(l=s,i=it(s),e.style.colorScheme=s?"dark":"light",K())}c();let x=matchMedia("(prefers-color-scheme: dark)"),d=()=>c();x.addEventListener("change",d);let g=new MutationObserver(()=>c());function u(){g.disconnect(),g.observe(document.documentElement,{attributes:!0}),document.body&&g.observe(document.body,{attributes:!0})}u(),un(()=>K());function y(){let s=devicePixelRatio;o.width=Math.round(innerWidth*s),o.height=Math.round(innerHeight*s),o.style.width=innerWidth+"px",o.style.height=innerHeight+"px",n.setTransform(s,0,0,s,0,0),n.translate(.5,.5)}let S=s=>Math.round(s)-.5;function p(s,h){n.strokeStyle=h,n.lineWidth=1,n.setLineDash([]),n.strokeRect(Math.round(s.left),Math.round(s.top),Math.round(s.width),Math.round(s.height))}function T(s){n.strokeStyle=ye(i.measure,.7),n.lineWidth=1,n.setLineDash([2,2]),n.beginPath();for(let h of[s.left,s.right])n.moveTo(Math.round(h),0),n.lineTo(Math.round(h),innerHeight);for(let h of[s.top,s.bottom])n.moveTo(0,Math.round(h)),n.lineTo(innerWidth,Math.round(h));n.stroke(),n.setLineDash([])}function M(s){if(n.strokeStyle=s.extension?ye(i.measure,.55):i.measure,n.lineWidth=1,n.setLineDash(s.extension?[3,3]:[]),n.beginPath(),n.moveTo(Math.round(s.x1),Math.round(s.y1)),n.lineTo(Math.round(s.x2),Math.round(s.y2)),s.extension){n.stroke();return}if(s.axis==="x")for(let h of[s.x1,s.x2])n.moveTo(Math.round(h),Math.round(s.y1)-He),n.lineTo(Math.round(h),Math.round(s.y1)+He);else for(let h of[s.y1,s.y2])n.moveTo(Math.round(s.x1)-He,Math.round(h)),n.lineTo(Math.round(s.x1)+He,Math.round(h));n.stroke()}function b(s){return n.font=`${I.medium} ${C.body}px ${C.stack}`,{w:n.measureText(s).width+ct*2,h:C.body+ct*2+2}}function B(s,h,m,G){n.font=`${I.medium} ${C.body}px ${C.stack}`,n.textBaseline="middle";let{w:v,h:f}=b(s),R=S(Math.min(Math.max(h,Me),innerWidth-v-Me)),J=S(Math.min(Math.max(m,Me),innerHeight-f-Me));n.fillStyle=G,n.beginPath(),n.roundRect(R,J,Math.ceil(v),f,4),n.fill(),n.fillStyle=i.surface,n.fillText(s,R+ct,J+f/2)}function X(s,h,m,G,v=!1){let{w:f,h:R}=b(s);B(s,v?h-f/2:h,v?m-R/2:m,G)}function F(){let s=scrollX,h=scrollY;n.fillStyle=i.rulerBg,n.fillRect(-.5,-.5,innerWidth+1,k),n.fillRect(-.5,-.5,k,innerHeight+1),n.strokeStyle=i.rulerLine,n.lineWidth=1,n.setLineDash([]),n.font=`${I.regular} 9px ${C.stack}`,n.fillStyle=i.muted,n.save(),n.globalAlpha=.16,n.fillStyle=i.accent;for(let f of r.pinned)n.fillRect(S(f.left),-.5,Math.round(f.width),k),n.fillRect(-.5,S(f.top),k,Math.round(f.height));n.restore(),n.beginPath(),n.moveTo(-.5,k-.5),n.lineTo(innerWidth,k-.5),n.moveTo(k-.5,-.5),n.lineTo(k-.5,innerHeight),n.stroke();let m=f=>f%vo===0?k:f%bo===0?7:4;n.textBaseline="top",n.textAlign="left",n.beginPath();let G=Math.floor(s/ve)*ve;for(let f=G;f<s+innerWidth;f+=ve){let R=Math.round(f-s);if(R<k)continue;let J=m(f);n.moveTo(R,k-J),n.lineTo(R,k),J===k&&(n.fillStyle=i.muted,n.fillText(String(f),R+3,3))}n.stroke(),n.beginPath();let v=Math.floor(h/ve)*ve;for(let f=v;f<h+innerHeight;f+=ve){let R=Math.round(f-h);if(R<k)continue;let J=m(f);n.moveTo(k-J,R),n.lineTo(k,R),J===k&&(n.save(),n.translate(3,R-3),n.rotate(-Math.PI/2),n.fillStyle=i.muted,n.fillText(String(f),0,0),n.restore())}n.stroke(),r.cursor&&(n.strokeStyle=i.accent,n.beginPath(),n.moveTo(Math.round(r.cursor.x),-.5),n.lineTo(Math.round(r.cursor.x),k),n.moveTo(-.5,Math.round(r.cursor.y)),n.lineTo(k,Math.round(r.cursor.y)),n.stroke()),n.fillStyle=i.guide;for(let f of r.guides){let R=Math.round(Te(f));f.axis==="x"?n.fillRect(R-1,-.5,2,k):n.fillRect(-.5,R-1,k,2)}n.fillStyle=i.rulerBg,n.fillRect(-.5,-.5,k,k),n.strokeStyle=i.rulerLine,n.strokeRect(-.5,-.5,k,k)}function U(){let s=on(10,1);if(s){n.strokeStyle=i.pixelLine,n.lineWidth=1,n.setLineDash([]),n.beginPath();for(let h=0;h<=innerWidth;h+=s)n.moveTo(h,0),n.lineTo(h,innerHeight);for(let h=0;h<=innerHeight;h+=s)n.moveTo(0,h),n.lineTo(innerWidth,h);n.stroke()}}function Y(s){let h=nn(s,document.documentElement.clientWidth);n.fillStyle=ye(i.measure,.08);for(let m of h)n.fillRect(S(m.left),-.5,Math.round(m.width),innerHeight+1)}function z(){a=0,n.save(),n.setTransform(1,0,0,1,0,0),n.clearRect(0,0,o.width,o.height),n.restore(),r.pixels&&U(),r.grid&&Y(r.grid);for(let m of r.pinned)p(m,i.accent);r.hover&&(T(r.hover),p(r.hover,r.pinned.length?ye(i.accent,.7):i.accent));for(let m of r.guides){let G=r.liveGuide?.id===m.id;n.strokeStyle=m.locked||G?i.guide:ye(i.guide,.55),n.lineWidth=m.pinned?2:1,n.setLineDash(m.locked?[]:[4,4]),n.beginPath();let v=Math.round(Te(m));if(m.axis==="x"?(n.moveTo(v,0),n.lineTo(v,innerHeight)):(n.moveTo(0,v),n.lineTo(innerWidth,v)),n.stroke(),r.activeGuide===m.id){n.lineWidth=3,n.setLineDash([]),n.beginPath();let f=7;m.axis==="x"?(n.moveTo(v,0),n.lineTo(v,f),n.moveTo(v,innerHeight-f),n.lineTo(v,innerHeight)):(n.moveTo(0,v),n.lineTo(f,v),n.moveTo(innerWidth-f,v),n.lineTo(innerWidth,v)),n.stroke()}}for(let m of r.lines)n.globalAlpha=m.faded?hn:1,M(m);n.globalAlpha=1;let s=r.lines.filter(m=>m.label!==""),h=s.map(m=>{let G=(m.x1+m.x2)/2,v=(m.y1+m.y2)/2,{w:f,h:R}=b(m.label);return m.axis==="x"?{x:G-f/2,y:v-16-R/2,w:f,h:R,axis:m.axis}:{x:G+26-f/2,y:v-R/2,w:f,h:R,axis:m.axis}});if(tn(h,{w:innerWidth,h:innerHeight},Me).forEach((m,G)=>{let v=s[G];n.globalAlpha=v.faded?hn:1,B(v.label,m.x,m.y,i.measure)}),n.globalAlpha=1,r.hover&&r.cursor){let{width:m,height:G,scale:v}=r.hover;X(`${E(m/v.x)} \xD7 ${E(G/v.y)}`,r.cursor.x+14,r.cursor.y+14,i.accent)}if(r.liveGuide){let m=r.liveGuide,G=Math.round(Te(m));X([`${m.axis} ${E(m.at)}`,m.caught,m.pinned?"pinned":""].filter(Boolean).join(" \xB7 "),m.axis==="x"?G+6:30,m.axis==="x"?30:G+6,i.guide)}r.rulers&&F()}function K(){a||(a=requestAnimationFrame(z))}return y(),{root:t,update(s){Object.assign(r,s),K()},resize(){y(),K()},destroy(){a&&cancelAnimationFrame(a),x.removeEventListener("change",d),g.disconnect(),e.remove()}}}function wo(e){let t=e.trim().replace(/^#/,""),o=t.length===3?t.split("").map(n=>n+n).join(""):t;return/^[0-9a-f]{6}$/i.test(o)?{r:parseInt(o.slice(0,2),16),g:parseInt(o.slice(2,4),16),b:parseInt(o.slice(4,6),16)}:null}function ko({r:e,g:t,b:o}){let n=r=>Math.round(r).toString(16).padStart(2,"0");return`#${n(e)}${n(t)}${n(o)}`}function So({r:e,g:t,b:o}){return`rgb(${Math.round(e)} ${Math.round(t)} ${Math.round(o)})`}function ge(e,t){return String(Number(e.toFixed(t)))}function $o({r:e,g:t,b:o}){let n=e/255,r=t/255,i=o/255,a=Math.max(n,r,i),l=Math.min(n,r,i),c=(a+l)/2,x=a-l,d=0,g=0;return x!==0&&(g=x/(1-Math.abs(2*c-1)),a===n?d=(r-i)/x%6:a===r?d=(i-n)/x+2:d=(n-r)/x+4,d*=60,d<0&&(d+=360)),`hsl(${ge(d,1)} ${ge(g*100,1)}% ${ge(c*100,1)}%)`}function ut(e){let t=e/255;return t<=.04045?t/12.92:((t+.055)/1.055)**2.4}function Eo(e){let t=ut(e.r),o=ut(e.g),n=ut(e.b),r=.4122214708*t+.5363325363*o+.0514459929*n,i=.2119034982*t+.6806995451*o+.1073969566*n,a=.0883024619*t+.2817188376*o+.6299787005*n,l=Math.cbrt(r),c=Math.cbrt(i),x=Math.cbrt(a),d=.2104542553*l+.793617785*c-.0040720468*x,g=1.9779984951*l-2.428592205*c+.4505937099*x,u=.0259040371*l+.7827717662*c-.808675766*x,y=Math.sqrt(g*g+u*u),S=Math.atan2(u,g)*180/Math.PI;return S<0&&(S+=360),y<1e-4?`oklch(${ge(d,4)} 0 0)`:`oklch(${ge(d,4)} ${ge(y,4)} ${ge(S,2)})`}function xn(e){let t=wo(e);return t?[{label:"hex",value:ko(t)},{label:"rgb",value:So(t)},{label:"hsl",value:$o(t)},{label:"oklch",value:Eo(t)}]:[]}var Co=`
.picker {
...
`;function Ke(e){let t=document.documentElement;if(!e){t.removeAttribute("data-align-xray"),document.getElementById(mt)?.remove();return}if(!document.getElementById(mt)){let o=document.createElement("style");o.id=mt,o.textContent=Ro,o.setAttribute("data-align-ignore",""),document.head.appendChild(o)}t.setAttribute("data-align-xray","")}var ft="align-ui";function vn(e){try{return localStorage.getItem(e)}catch{return null}}function wn(e,t){try{localStorage.setItem(e,t)}catch{}}function kn(e){let t="/";try{t=location.pathname||"/"}catch{}return`${ft}:${e}::${t}`}function Lo(e){if(typeof e!="object"||e===null)return!1;let t=e;return(t.axis==="x"||t.axis==="y")&&typeof t.at=="number"&&Number.isFinite(t.at)}function Sn(){let e=vn(kn("guides"));if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.filter(Lo).map(o=>({id:0,axis:o.axis,at:o.at,locked:o.locked===!0,pinned:o.pinned===!0,caught:typeof o.caught=="string"?o.caught:""})):[]}catch{return[]}}function $n(e){wn(kn("guides"),JSON.stringify(e.map(t=>({axis:t.axis,at:t.at,locked:t.locked,pinned:t.pinned,caught:t.caught}))))}function _e(e){return vn(`${ft}:${e}`)==="1"}function Ae(e,t){wn(`${ft}:${e}`,t?"1":"0")}var j,L=null,W=null,de=null,Ce=null,te=!1,ke=_e("grid"),Se=_e("pixels"),D=null,$=[],Ue=0,ne=_e("rulers"),A=[],Gn=1,En=!1,le=null,xt=pn();function Mo(){return A.map(e=>({...e}))}function $e(e=""){xt.push(Mo(),e)}function Cn(){return A.find(e=>e.id===le)??null}function ue(e){A=e,$n(A)}var P=null,ee=null,Q=null,Go=3,we=22;function An(e,t){return ne?t<we&&e>=we?"y":e<we&&t>=we?"x":null:null}function yt(e){return e.ctrlKey||e.metaKey}function Bn(e,t,o,n){let r=pe(t,o,j),i=e.axis==="x"?t:o,a=A.filter(c=>c.id!==e.id).map(c=>({axis:c.axis,at:Be(c).pos})),l=Qt(i,Zt(r,e.axis,a),n);e.at=l.at+(e.axis==="x"?scrollX:scrollY),e.caught=l.what}function Nn(e,t,o,n){let r={id:Gn++,axis:e,at:0,locked:!1,caught:"",pinned:!1};return $e(),Bn(r,t,o,n),ue([...A,r]),le=r.id,r}function Dn(e){e.pinned||($e(),ue(A.filter(t=>t.id!==e.id)),ee?.id===e.id&&(ee=null),P?.id===e.id&&(P=null))}function Ao(e){let t=j.hotkey.toLowerCase().split("+"),o=t[t.length-1];return e.key.toLowerCase()!==o||t.includes("shift")!==e.shiftKey||t.includes("alt")!==e.altKey?!1:(t.includes("mod")||t.includes("ctrl")||t.includes("cmd"))===(e.metaKey||e.ctrlKey)}function Be(e){return{axis:e.axis,pos:e.axis==="x"?e.at-scrollX:e.at-scrollY}}function bt(){return $.length>=2?$[$.length-2]:void 0}function vt(){if($.length<2)return[];let e=[];for(let[t,o]of et($))for(let n of Ie(t,o)){if(n.extension||!n.label)continue;let r=Pt(t.el,o.el,parseFloat(n.label),n.axis);e.push({px:r.px,detail:Ft(r)})}return e}function O(e){let t=$[$.length-1],o=D&&$.some(u=>u.el===D.el),n=A.map(Be),r=!P&&ee?ee:null,i=A.filter(u=>u.locked||u.id===r?.id),a=!r&&o?D.el:null,l=r??a,c=r?Be(r):null,x=[],d=(u,y)=>{for(let S of u)x.push(l&&!y?{...S,faded:!0}:S)},g=u=>!c||u.axis!==c.axis?!1:(u.axis==="x"?[u.x1,u.x2]:[u.y1,u.y2]).some(S=>Math.abs(S-c.pos)<.5);for(let[u,y]of et($))d(Ie(u,y),u.el===a||y.el===a);t&&D&&!o&&!r&&d(Ie(t,D),!0);for(let u of i)for(let y of $)d(nt(y,[Be(u)]),u.id===r?.id||y.el===a);D&&!o&&!r&&A.length&&d(nt(D,n),!0);for(let u of en(i.map(Be),{x:innerWidth/2,y:innerHeight/2}))d([u],g(u));L?.update({hover:D,pinned:$,rulers:ne,grid:ke&&j.grid?j.grid:null,pixels:Se,guides:A,liveGuide:P??ee,activeGuide:le,lines:x,...e?{cursor:e}:{}}),de?.update($.length,{rulers:ne,xray:te,grid:ke,pixels:Se,freeze:Ge(),type:W?.showsType()??!1,panel:W?.isOpen()??!1})}function On(){let e=W?.asText()??"";e&&navigator.clipboard?.writeText(e).catch(()=>{})}function Pn(){let e=xt.pop();e&&(ue(e),ee=null,P=null,Q=null,e.some(t=>t.id===le)||(le=null))}function ht(e){switch(e){case"rulers":ne=!ne,Ae("rulers",ne);break;case"xray":te=!te,Ke(te);break;case"grid":ke=!ke,Ae("grid",ke);break;case"pixels":Se=!Se,Ae("pixels",Se);break;case"freeze":Ye(!Ge());break;case"type":W?.toggleType();break;case"panel":W?.toggle();break;case"copy":On();break;case"pick":Ce?.open();break;case"undo":Pn();break}O()}var je=null;function Fn(e){if(je={x:e.clientX,y:e.clientY},P){Q&&Math.hypot(e.clientX-Q.x,e.clientY-Q.y)>Go&&(Q=null),!Q&&!P.pinned&&(Bn(P,e.clientX,e.clientY,yt(e)),ue([...A])),O({x:e.clientX,y:e.clientY});return}ee=tt(A,e.clientX,e.clientY),D=pe(e.clientX,e.clientY,j),O({x:e.clientX,y:e.clientY})}function In(e){P&&(Q?(P.locked=!P.locked,le=P.id,ue([...A])):(An(e.clientX,e.clientY)||e.clientX<we||e.clientY<we)&&Dn(P),Q=null,P=null,O({x:e.clientX,y:e.clientY}))}function zn(e){if(e.button!==0)return;let t=pe(e.clientX,e.clientY,j);if(!t)return;let o=An(e.clientX,e.clientY);if(o){Ee(e),Q=null,P=Nn(o,e.clientX,e.clientY,yt(e)),O({x:e.clientX,y:e.clientY});return}let n=tt(A,e.clientX,e.clientY);if(n){Ee(e),$e(),le=n.id,P=n,Q={x:e.clientX,y:e.clientY},O({x:e.clientX,y:e.clientY});return}Ee(e),de?.closeHelp(),$=[t],D=t,W?.show(t,vt(),bt()),O({x:e.clientX,y:e.clientY})}function Hn(e){let t=pe(e.clientX,e.clientY,j);if(!t)return;Ee(e),de?.closeHelp();let o=$.findIndex(r=>r.el===t.el);$=o>=0?$.filter((r,i)=>i!==o):[...$,t],D=t;let n=$[$.length-1];n?W?.show(n,vt(),bt()):W?.hide(),O({x:e.clientX,y:e.clientY})}function Wn(e){pe(e.clientX,e.clientY,j)&&Ee(e)}function Xn(e){pe(e.clientX,e.clientY,j)&&Ee(e)}function Ee(e){e.preventDefault(),e.stopPropagation()}function Tn(e,t){return e.left===t.left&&e.top===t.top&&e.width===t.width&&e.height===t.height}var Rn=0,Ln=0;function Yn(){Ue=requestAnimationFrame(Yn);let t=$.filter(a=>a.el.isConnected).map(a=>Fe(a.el)),o=D&&D.el.isConnected?Fe(D.el):null;if(!(scrollX!==Rn||scrollY!==Ln||t.length!==$.length||t.some((a,l)=>!Tn(a,$[l]))||D===null!=(o===null)||D!==null&&o!==null&&!Tn(D,o)))return;Rn=scrollX,Ln=scrollY,$=t,D=o;let i=$[$.length-1];i?W?.show(i,vt(),bt()):W?.hide(),O()}function Kn(){L?.resize()}function Bo(){En||(En=!0,A=Sn().map(e=>({...e,id:Gn++}))),!L&&(sn(),L=gn(),W=dn(L.root),de=fn(L.root,ht),Ce=yn(L.root),de.update(0,{rulers:ne,xray:te,grid:ke,pixels:Se,freeze:Ge(),type:!1,panel:!1}),addEventListener("mousemove",Fn),addEventListener("mousedown",zn,{capture:!0}),addEventListener("mouseup",In,{capture:!0}),addEventListener("click",Wn,{capture:!0}),addEventListener("auxclick",Xn,{capture:!0}),addEventListener("contextmenu",Hn,{capture:!0}),addEventListener("resize",Kn),Ue=requestAnimationFrame(Yn),O())}function gt(){removeEventListener("mousemove",Fn),removeEventListener("mousedown",zn,{capture:!0}),removeEventListener("mouseup",In,{capture:!0}),removeEventListener("click",Wn,{capture:!0}),removeEventListener("auxclick",Xn,{capture:!0}),removeEventListener("contextmenu",Hn,{capture:!0}),removeEventListener("resize",Kn),cancelAnimationFrame(Ue),Ue=0,de?.destroy(),Ce?.destroy(),Ce=null,te&&(te=!1,Ke(!1)),Ye(!1),de=null,W?.destroy(),W=null,L?.destroy(),L=null,cn(),D=null,$=[],P=null,Q=null,ee=null}function Mn(e){if(Ao(e))e.preventDefault(),L?gt():Bo();else if(L&&je&&(e.key.toLowerCase()===j.guideKeys.vertical||e.key.toLowerCase()===j.guideKeys.horizontal)){e.preventDefault();let t=e.key.toLowerCase()===j.guideKeys.vertical?"x":"y";Nn(t,je.x,je.y,yt(e)),O()}else if(L&&(e.key==="Delete"||e.key==="Backspace"))e.preventDefault(),e.shiftKey?($e(),ue(A.filter(t=>t.pinned)),ee=null,P=null,Q=null,A.some(t=>t.id===le)||(le=null)):ee&&Dn(ee),O();else if(L&&e.key.startsWith("Arrow")){let t=Cn(),o=e.key==="ArrowLeft"||e.key==="ArrowRight"?"x":"y";if(!t||t.axis!==o||(e.preventDefault(),t.pinned))return;$e(`nudge:${t.id}`);let n=e.shiftKey?10:1;t.at+=e.key==="ArrowLeft"||e.key==="ArrowUp"?-n:n,t.caught="",ue([...A]),O()}else if(L&&e.key.toLowerCase()==="g"){e.preventDefault(),ht("grid");return}else if(L&&e.key.toLowerCase()==="k"){e.preventDefault(),ht("pixels");return}else if(L&&e.key.toLowerCase()==="f")e.preventDefault(),Ye(!Ge()),O();else if(L&&e.key.toLowerCase()==="x")e.preventDefault(),te=!te,Ke(te);else if(L&&e.key.toLowerCase()==="p")e.preventDefault(),Ce?.open();else if(L&&e.key.toLowerCase()==="t")e.preventDefault(),W?.toggleType();else if(L&&e.key.toLowerCase()==="c")e.preventDefault(),On();else if(L&&e.key.toLowerCase()==="l"){let t=Cn();if(!t)return;e.preventDefault(),$e(),t.pinned=!t.pinned,ue([...A]),O()}else if(L&&(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){if(xt.depth()===0)return;e.preventDefault(),Pn(),O()}else if(L&&e.key.toLowerCase()===j.rulerKey)e.preventDefault(),ne=!ne,Ae("rulers",ne),O();else if(L&&e.key.toLowerCase()===j.panelKey)e.preventDefault(),W?.toggle();else if(e.key==="Escape"&&L){if(Ce?.close()||de?.closeHelp())return;$.length?($=[],W?.hide(),O()):gt()}}function fr(e={}){if(typeof window>"u"||window.__align)return;window.__align=!0,j=Ut(e),addEventListener("keydown",Mn,{capture:!0});let t=import.meta.hot;t&&t.dispose(()=>{gt(),removeEventListener("keydown",Mn,{capture:!0}),delete window.__align})}export{fr as initAlign};
