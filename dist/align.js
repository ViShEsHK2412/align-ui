...
`;function Tt(e){let t=document.documentElement;if(!e){t.removeAttribute("data-align-xray"),document.getElementById(Ct)?.remove();return}if(!document.getElementById(Ct)){let o=document.createElement("style");o.id=Ct,o.textContent=zo,o.setAttribute("data-align-ignore",""),document.head.appendChild(o)}t.setAttribute("data-align-xray","")}var Mt="align-ui";function Rn(e){try{return localStorage.getItem(e)}catch{return null}}function An(e,t){try{localStorage.setItem(e,t)}catch{}}function Gn(e){let t="/";try{t=location.pathname||"/"}catch{}return`${Mt}:${e}::${t}`}function Wo(e){if(typeof e!="object"||e===null)return!1;let t=e;return(t.axis==="x"||t.axis==="y")&&typeof t.at=="number"&&Number.isFinite(t.at)}function Nn(){let e=Rn(Gn("guides"));if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.filter(Wo).map(o=>({id:0,axis:o.axis,at:o.at,locked:o.locked===!0,pinned:o.pinned===!0,caught:typeof o.caught=="string"?o.caught:""})):[]}catch{return[]}}function Bn(e){An(Gn("guides"),JSON.stringify(e.map(t=>({axis:t.axis,at:t.at,locked:t.locked,pinned:t.pinned,caught:t.caught}))))}function et(e){return Rn(`${Mt}:${e}`)==="1"}function tt(e,t){An(`${Mt}:${e}`,t?"1":"0")}var U,G=null,J=null,ue=null,ze=null,ve=!1,Re=et("grid"),Ae=et("pixels"),H=null,$=[],ot=0,ke=et("rulers"),O=[],Wn=1,In=!1,de=null,we=$n();function Xo(){return O.map(e=>({...e}))}function Ge(e=""){we.push(Xo(),e)}function On(){return O.find(e=>e.id===de)??null}function fe(e){O=e,Bn(O)}var X=null,ie=null,ne=null,Yo=3,Le=22;function Xn(e,t){return ke?t<Le&&e>=Le?"y":e<Le&&t>=Le?"x":null:null}function Rt(e){return e.ctrlKey||e.metaKey}function Yn(e,t,o,n){let r=ge(t,o,U),i=e.axis==="x"?t:o,a=O.filter(c=>c.id!==e.id).map(c=>({axis:c.axis,at:He(c).pos})),s=un(i,dn(r,e.axis,a),n);e.at=s.at+(e.axis==="x"?scrollX:scrollY),e.caught=s.what}function Kn(e,t,o,n){let r={id:Wn++,axis:e,at:0,locked:!1,caught:"",pinned:!1};return Ge(),Yn(r,t,o,n),fe([...O,r]),de=r.id,r}function _n(e){e.pinned||(Ge(),fe(O.filter(t=>t.id!==e.id)),ie?.id===e.id&&(ie=null),X?.id===e.id&&(X=null))}function Ko(e){let t=U.hotkey.toLowerCase().split("+"),o=t[t.length-1];return e.key.toLowerCase()!==o||t.includes("shift")!==e.shiftKey||t.includes("alt")!==e.altKey?!1:(t.includes("mod")||t.includes("ctrl")||t.includes("cmd"))===(e.metaKey||e.ctrlKey)}function He(e){return{axis:e.axis,pos:e.axis==="x"?e.at-scrollX:e.at-scrollY}}function At(){return $.length>=2?$[$.length-2]:void 0}function Gt(){if($.length<2)return[];let e=[];for(let[t,o]of ut($))for(let n of je(t,o)){if(n.extension||!n.label)continue;let r=Ut(t.el,o.el,parseFloat(n.label),n.axis);e.push({px:r.px,detail:Vt(r)})}return e}function V(e){let t=$[$.length-1],o=H&&$.some(p=>p.el===H.el),n=O.map(He),r=!X&&ie?ie:null,i=O.filter(p=>p.locked||p.id===r?.id),a=!r&&o?H.el:null,s=r??a,c=r?He(r):null,m=[],g=(p,d)=>{for(let f of p)m.push(s&&!d?{...f,faded:!0}:f)},S=p=>!c||p.axis!==c.axis?!1:(p.axis==="x"?[p.x1,p.x2]:[p.y1,p.y2]).some(f=>Math.abs(f-c.pos)<.5);for(let[p,d]of ut($))g(je(p,d),p.el===a||d.el===a);t&&H&&!o&&!r&&g(je(t,H),!0);for(let p of i)for(let d of $)g(pt(d,[He(p)]),p.id===r?.id||d.el===a);H&&!o&&!r&&O.length&&g(pt(H,n),!0);for(let p of pn(i.map(He),{x:innerWidth/2,y:innerHeight/2}))g([p],S(p));G?.update({hover:H,pinned:$,rulers:ke,grid:Re&&U.grid?U.grid:null,pixels:Ae,guides:O,liveGuide:X??ie,activeGuide:de,lines:m,...e?{cursor:e}:{}}),ue?.update($.length,{rulers:ke,xray:ve,grid:Re,pixels:Ae,freeze:Ze(),type:J?.showsType()??!1,canCopy:$.length>0,canUndo:we.depth()>0,panel:J?.isOpen()??!1})}function _o(){let e=J?.asText()??"";if(!e)return;let t=n=>ue?.acknowledge("copy",n),o=navigator.clipboard?.writeText(e);o?o.then(()=>t(!0),()=>t(!1)):t(!1)}function jo(e,t){return e.length===t.length&&e.every((o,n)=>{let r=t[n];return o.id===r.id&&o.axis===r.axis&&o.at===r.at&&o.locked===r.locked&&o.pinned===r.pinned})}function Uo(){for(;we.depth()>0&&jo(we.peek(),O);)we.pop();let e=we.pop();e&&(fe(e),ie=null,X=null,ne=null,e.some(t=>t.id===de)||(de=null))}function re(e){switch(e){case"rulers":ke=!ke,tt("rulers",ke);break;case"xray":ve=!ve,Tt(ve);break;case"grid":Re=!Re,tt("grid",Re);break;case"pixels":Ae=!Ae,tt("pixels",Ae);break;case"freeze":Et(!Ze());break;case"type":J?.toggleType();break;case"panel":J?.toggle();break;case"copy":_o();break;case"pick":ze?.open();break;case"undo":Uo();break}V()}var nt=null;function jn(e){if(nt={x:e.clientX,y:e.clientY},X){ne&&Math.hypot(e.clientX-ne.x,e.clientY-ne.y)>Yo&&(ne=null),!ne&&!X.pinned&&(Yn(X,e.clientX,e.clientY,Rt(e)),fe([...O])),V({x:e.clientX,y:e.clientY});return}ie=dt(O,e.clientX,e.clientY),H=ge(e.clientX,e.clientY,U),V({x:e.clientX,y:e.clientY})}function Un(e){X&&(ne?(X.locked=!X.locked,de=X.id,fe([...O])):(Xn(e.clientX,e.clientY)||e.clientX<Le||e.clientY<Le)&&_n(X),ne=null,X=null,V({x:e.clientX,y:e.clientY}))}function Vn(e){if(e.button!==0)return;let t=ge(e.clientX,e.clientY,U);if(!t)return;let o=Xn(e.clientX,e.clientY);if(o){Ne(e),ne=null,X=Kn(o,e.clientX,e.clientY,Rt(e)),V({x:e.clientX,y:e.clientY});return}let n=dt(O,e.clientX,e.clientY);if(n){Ne(e),Ge(),de=n.id,X=n,ne={x:e.clientX,y:e.clientY},V({x:e.clientX,y:e.clientY});return}Ne(e),ue?.closeHelp(),$=[t],H=t,J?.show(t,Gt(),At()),V({x:e.clientX,y:e.clientY})}function qn(e){let t=ge(e.clientX,e.clientY,U);if(!t)return;Ne(e),ue?.closeHelp();let o=$.findIndex(r=>r.el===t.el);$=o>=0?$.filter((r,i)=>i!==o):[...$,t],H=t;let n=$[$.length-1];n?J?.show(n,Gt(),At()):J?.hide(),V({x:e.clientX,y:e.clientY})}function Jn(e){ge(e.clientX,e.clientY,U)&&Ne(e)}function Qn(e){ge(e.clientX,e.clientY,U)&&Ne(e)}function Ne(e){e.preventDefault(),e.stopPropagation()}function Dn(e,t){return e.left===t.left&&e.top===t.top&&e.width===t.width&&e.height===t.height}var Pn=0,Fn=0;function Zn(){ot=requestAnimationFrame(Zn);let t=$.filter(s=>s.el.isConnected).map(s=>_e(s.el)),o=H&&H.el.isConnected?_e(H.el):null;if(!(scrollX!==Pn||scrollY!==Fn||t.length!==$.length||t.some((s,c)=>!Dn(s,$[c]))||H===null!=(o===null)||H!==null&&o!==null&&!Dn(H,o)))return;Pn=scrollX,Fn=scrollY,$=t,H=o;let i=$[$.length-1],a=Vo();a!==Hn&&(Hn=a,i?J?.show(i,Gt(),At()):J?.hide()),V()}var Hn="";function Vo(){let e=$[0];return e?$.map(t=>[t.label,Math.round(t.width*100),Math.round(t.height*100),Math.round((t.left-e.left)*100),Math.round((t.top-e.top)*100)].join(",")).join(";"):""}function eo(){G?.resize()}function qo(){In||(In=!0,O=Nn().map(e=>({...e,id:Wn++}))),!G&&(bn(),G=Cn(),J=kn(G.root),ue=Sn(G.root,re),ze=Mn(G.root),ue.update(0,{rulers:ke,xray:ve,grid:Re,pixels:Ae,freeze:Ze(),type:!1,panel:!1,canCopy:!1,canUndo:!1}),addEventListener("mousemove",jn),addEventListener("mousedown",Vn,{capture:!0}),addEventListener("mouseup",Un,{capture:!0}),addEventListener("click",Jn,{capture:!0}),addEventListener("auxclick",Qn,{capture:!0}),addEventListener("contextmenu",qn,{capture:!0}),addEventListener("resize",eo),ot=requestAnimationFrame(Zn),V())}function Lt(){removeEventListener("mousemove",jn),removeEventListener("mousedown",Vn,{capture:!0}),removeEventListener("mouseup",Un,{capture:!0}),removeEventListener("click",Jn,{capture:!0}),removeEventListener("auxclick",Qn,{capture:!0}),removeEventListener("contextmenu",qn,{capture:!0}),removeEventListener("resize",eo),cancelAnimationFrame(ot),ot=0,ue?.destroy(),ze?.destroy(),ze=null,ve&&(ve=!1,Tt(!1)),Et(!1),ue=null,J?.destroy(),J=null,G?.destroy(),G=null,wn(),H=null,$=[],X=null,ne=null,ie=null}function zn(e){if(Ko(e))e.preventDefault(),G?Lt():qo();else if(G&&nt&&(e.key.toLowerCase()===U.guideKeys.vertical||e.key.toLowerCase()===U.guideKeys.horizontal)){e.preventDefault();let t=e.key.toLowerCase()===U.guideKeys.vertical?"x":"y";Kn(t,nt.x,nt.y,Rt(e)),V()}else if(G&&(e.key==="Delete"||e.key==="Backspace"))e.preventDefault(),e.shiftKey?(O.some(t=>!t.pinned)&&Ge(),fe(O.filter(t=>t.pinned)),ie=null,X=null,ne=null,O.some(t=>t.id===de)||(de=null)):ie&&_n(ie),V();else if(G&&e.key.startsWith("Arrow")){let t=On(),o=e.key==="ArrowLeft"||e.key==="ArrowRight"?"x":"y";if(!t||t.axis!==o||(e.preventDefault(),t.pinned))return;Ge(`nudge:${t.id}`);let n=e.shiftKey?10:1;t.at+=e.key==="ArrowLeft"||e.key==="ArrowUp"?-n:n,t.caught="",fe([...O]),V()}else if(G&&e.key.toLowerCase()==="g"){e.preventDefault(),re("grid");return}else if(G&&e.key.toLowerCase()==="k"){e.preventDefault(),re("pixels");return}else if(G&&e.key.toLowerCase()==="f"){e.preventDefault(),re("freeze");return}else if(G&&e.key.toLowerCase()==="x"){e.preventDefault(),re("xray");return}else if(G&&e.key.toLowerCase()==="p"){e.preventDefault(),re("pick");return}else if(G&&e.key.toLowerCase()==="t"){e.preventDefault(),re("type");return}else if(G&&e.key.toLowerCase()==="c"){e.preventDefault(),re("copy");return}else if(G&&e.key.toLowerCase()==="l"){let t=On();if(!t)return;e.preventDefault(),Ge(),t.pinned=!t.pinned,fe([...O]),V()}else if(G&&(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){if(we.depth()===0)return;e.preventDefault(),re("undo");return}else if(G&&e.key.toLowerCase()===U.rulerKey){e.preventDefault(),re("rulers");return}else if(G&&e.key.toLowerCase()===U.panelKey){e.preventDefault(),re("panel");return}else if(e.key==="Escape"&&G){if(ze?.close()||ue?.closeHelp())return;$.length?($=[],J?.hide(),V()):Lt()}}function Br(e={}){if(typeof window>"u"||window.__align)return;window.__align=!0,U=an(e),addEventListener("keydown",zn,{capture:!0});let t=import.meta.hot;t&&t.dispose(()=>{Lt(),removeEventListener("keydown",zn,{capture:!0}),delete window.__align})}export{Br as initAlign};
