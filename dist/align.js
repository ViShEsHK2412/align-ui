function xe(e){let t=parseFloat(e);return Number.isFinite(t)?t:NaN}function $r(e){return(e.split(",")[0]??"").trim().replace(/^['"]|['"]$/g,"")}function Er(e){let o={100:"thin",200:"extralight",300:"light",400:"regular",500:"medium",600:"semibold",700:"bold",800:"extrabold",900:"black"}[e.trim()];return o?`${e} ${o}`:e}function Nt(e){let t=getComputedStyle(e);return[{label:"family",value:$r(t.fontFamily),px:NaN},{label:"size",value:t.fontSize,px:xe(t.fontSize)},{label:"weight",value:Er(t.fontWeight),px:NaN},{label:"line",value:t.lineHeight,px:xe(t.lineHeight)},{label:"tracking",value:t.letterSpacing,px:xe(t.letterSpacing)}]}function Kn(e){let t="";for(let o of e.childNodes)o.nodeType===3&&(t+=o.nodeValue??"");return t.trim().replace(/\s+/g," ")}function Rt(e){let t=getComputedStyle(e),o=[];for(let n of Array.from(t)){if(!n.startsWith("--"))continue;let r=t.getPropertyValue(n).trim();o.push({name:n,value:r,px:xe(r)})}return o}function sn(e,t){return Number.isFinite(e)?t.filter(o=>o.value.endsWith("px")&&Math.abs(o.px-e)<.01).map(o=>o.name).sort():[]}function Sr(e){let t=new Set,o=[];for(let n of e)!Number.isFinite(n)||n===0||t.has(n)||(t.add(n),o.push(n));return o}function Yn(e,t){if(t.length===0)return"";let o=[],n=0;for(let i of Sr(e)){let a=sn(i,t);a.length?o.push(`${Cr(i)} ${a.join(" ")}`):n+=1}if(o.length===0)return n===1?"its one number is not on the scale":`none of its ${n} numbers are on the scale`;let r=n===0?"":n===1?"  \xB7  1 more, not on the scale":`  \xB7  ${n} more, not on the scale`;return o.join("  \xB7  ")+r}function Cr(e){return String(Math.round(e*100)/100)}function Bn(e){let t=getComputedStyle(e);return[t.marginTop,t.marginRight,t.marginBottom,t.marginLeft].map(xe)}function jn(e,t,o,n){let r=e.parentElement,i=r!==null&&t.parentElement===r;if(!r||!i)return{px:o,cssGap:null,margins:0,siblings:!1};let a=getComputedStyle(r),s=a.display.includes("flex")||a.display.includes("grid"),u=n==="x"?a.columnGap:a.rowGap,S=s&&u!=="normal"?xe(u):null,[v,N,c,w]=Bn(e),[C,E,W,p]=Bn(t),g=j=>Number.isFinite(j)?j:0,_=n==="x"?e.getBoundingClientRect().left<t.getBoundingClientRect().left:e.getBoundingClientRect().top<t.getBoundingClientRect().top,X=n==="x"?_?g(N)+g(p):g(E)+g(w):_?g(c)+g(C):g(W)+g(v);return{px:o,cssGap:S,margins:X,siblings:!0}}function Un(e){if(!e.siblings)return"not siblings";let t=[];e.cssGap!==null&&t.push(`gap ${e.cssGap}`),(e.margins!==0||e.cssGap===null)&&t.push(`margins ${e.margins}`);let o=(e.cssGap??0)+e.margins;return Math.abs(o-e.px)>.5&&t.push("rest from layout"),t.join(" \xB7 ")}function Vn(e){let t=new Map;for(let o of e)t.set(o,(t.get(o)??0)+1);return t.size<2?"":[...t.entries()].sort((o,n)=>n[1]-o[1]||o[0]-n[0]).map(([o,n])=>`${o} \xD7${n}`).join(" \xB7 ")}function yt(e){let t=e.trim().toLowerCase();return t?t.startsWith("#")||/^(rgba?|hsla?|hwb|lab|lch|oklab|oklch|color)\(/.test(t)?!0:["black","white","transparent","currentcolor"].includes(t):!1}var Be;function On(e){if(Be===void 0&&(Be=document.createElement("canvas").getContext("2d")),!Be)return"";Be.fillStyle="#000000",Be.fillStyle=e;let t=Be.fillStyle;return Be.fillStyle="#ffffff",Be.fillStyle=e,t===Be.fillStyle?String(t):""}function Pt(e,t){let o=On(e);return o?t.filter(n=>yt(n.value)&&On(n.value)===o).map(n=>n.name).sort():[]}function qn(e){let t=getComputedStyle(e),o=[],n=(r,i)=>{let a=i.trim();!a||a==="transparent"||/rgba?\([^)]*,\s*0\s*\)$/.test(a)||o.push({label:r,value:a})};return n("text",t.color),n("background",t.backgroundColor),o}function Tr(e,t,o){let n=r=>typeof CSS<"u"&&CSS.escape?CSS.escape(r):r.replace(/[^\w-]/g,"\\$&");return t?`#${n(t)}`:o.length?e+o.map(r=>`.${n(r)}`).join(""):e}function xt(e){let t=typeof e.className=="string"?e.className.trim().split(/\s+/).filter(Boolean):[];return Tr(e.tagName.toLowerCase(),e.id,t)}function Zn(e){let t=xt(e);if(!/[.#]/.test(t))return 0;try{return document.querySelectorAll(t).length}catch{return 0}}function Mr(e){if(!e)return"inline <style>";let t=e.split("?")[0]??e;try{let o=new URL(t,"http://x").pathname;return decodeURI(o).replace(/^\//,"")||t}catch{return t}}var Ar=["width","height","padding","margin","border-width","gap","font-size","line-height","letter-spacing","color","background-color"];function Lr(e){for(let t=0;t<e.length;t+=1){let o=e.item(t);if(Ar.some(n=>o===n||o.startsWith(`${n}-`)))return!0}return!1}function Jn(e){let t=[],o=new Set,n=(r,i)=>{for(let a of Array.from(r)){if(a instanceof CSSMediaRule){matchMedia(a.conditionText).matches&&n(a.cssRules,i);continue}if(a instanceof CSSSupportsRule){CSS.supports(a.conditionText)&&n(a.cssRules,i);continue}let s=a.cssRules;if(s&&!(a instanceof CSSStyleRule)){n(s,i);continue}if(!(a instanceof CSSStyleRule))continue;let u=!1;try{u=e.matches(a.selectorText)}catch{continue}if(!u||!Lr(a.style))continue;let S=`${a.selectorText}|${i}`;o.has(S)||(o.add(S),t.push({selector:a.selectorText,file:i}))}};for(let r of Array.from(document.styleSheets)){if(r.ownerNode instanceof Element&&r.ownerNode.hasAttribute("data-align-ignore"))continue;let i;try{i=r.cssRules}catch{continue}n(i,Mr(r.href))}return t.reverse()}function zn(e){if(!e||e==="none")return[];let t=e.trim().split(/\s+/),o=[];for(let n of t){if(!n.endsWith("px"))return[];let r=Number.parseFloat(n);if(!Number.isFinite(r))return[];o.push(r)}return o}function Fn(e,t,o){let n=0;for(let r=0;r<e.length;r+=1){let i=n+e[r];if(o<i+.5)return r;n=i+t}return-1}function Nr(e,t){let o=t==="rtl";return e.startsWith("vertical")||e.startsWith("sideways")?{inline:"y",inlineReversed:e==="sideways-lr"?!o:o,blockReversed:e==="vertical-rl"||e==="sideways-rl"}:{inline:"x",inlineReversed:o,blockReversed:!1}}function Wn(e,t,o,n,r){return r?t-n:o-e}function Qn(e){let t=e.parentElement,o=0;for(;t&&getComputedStyle(t).display==="contents";)t=t.parentElement,o+=1;if(!t)return null;let n=getComputedStyle(t),r=getComputedStyle(e),i=n.display,a=[];if(o>0&&a.push({label:"through",value:o===1?"a display: contents parent":`${o} display: contents parents`}),r.position==="absolute"||r.position==="fixed")return a.push({label:"placed by",value:`${r.position}, not by the parent`}),{display:i,rows:a};if(r.float!=="none")return a.push({label:"placed by",value:`float: ${r.float}`}),{display:i,rows:a};let s=i.includes("flex"),u=i.includes("grid");if(!s&&!u)return a.push({label:"flow",value:i}),{display:i,rows:a};let S=_n(n.rowGap==="normal"?"0px":n.rowGap),v=_n(n.columnGap==="normal"?"0px":n.columnGap),N=S===v?S:`row ${S} \xB7 column ${v}`;if(s){let q=n.flexDirection;a.push({label:"direction",value:n.flexWrap==="nowrap"?q:`${q} \xB7 ${n.flexWrap}`}),a.push({label:"justify",value:n.justifyContent}),a.push({label:"align",value:n.alignItems}),a.push({label:"gap",value:N});let b=`${r.flexGrow} ${r.flexShrink} ${r.flexBasis}`;return b!=="0 1 auto"&&a.push({label:"this child",value:`flex: ${b}`}),r.alignSelf!=="auto"&&a.push({label:"align-self",value:r.alignSelf}),{display:i,rows:a}}let c=zn(n.gridTemplateColumns),w=zn(n.gridTemplateRows);c.length&&a.push({label:"columns",value:`${c.length} \xB7 ${c.map(an).join(" ")}`}),w.length&&a.push({label:"rows",value:`${w.length} \xB7 ${w.map(an).join(" ")}`}),a.push({label:"gap",value:N});let C=t.getBoundingClientRect(),E=e.getBoundingClientRect(),W={left:C.left+xe(n.borderLeftWidth)+xe(n.paddingLeft),right:C.right-xe(n.borderRightWidth)-xe(n.paddingRight),top:C.top+xe(n.borderTopWidth)+xe(n.paddingTop),bottom:C.bottom-xe(n.borderBottomWidth)-xe(n.paddingBottom)},p=Nr(n.writingMode,n.direction),g=(q,b)=>q==="x"?Wn(W.left,W.right,E.left,E.right,b):Wn(W.top,W.bottom,E.top,E.bottom,b),_=p.inline==="x"?"y":"x",X=xe(n.columnGap==="normal"?"0":n.columnGap),j=xe(n.rowGap==="normal"?"0":n.rowGap),le=Fn(c,X,g(p.inline,p.inlineReversed)),ie=Fn(w,j,g(_,p.blockReversed)),Q=[];return le>=0&&Q.push(`column ${le+1} of ${c.length}`),ie>=0&&Q.push(`row ${ie+1} of ${w.length}`),Q.length&&a.push({label:"this child",value:Q.join(" \xB7 ")}),{display:i,rows:a}}function _n(e){return e.endsWith("px")?an(Number.parseFloat(e)):e}function an(e){return String(Math.round(e*100)/100)}var eo=["display","position","width","height","padding","margin","border-width","border-style","border-radius","font-family","font-size","font-weight","font-style","line-height","letter-spacing","text-transform","text-align","color","background-color","border-color","opacity","flex-direction","justify-content","align-items","gap","flex-grow","flex-shrink","flex-basis","align-self","box-shadow","overflow","text-overflow","white-space"];function Rr(e,t){let o=[];for(let n of eo){let r=e[n]??"",i=t[n]??"";r!==i&&o.push({prop:n,a:r,b:i})}return o}function Xn(e){let t=getComputedStyle(e),o={};for(let n of eo)o[n]=t.getPropertyValue(n);return o}function to(e,t){return Rr(Xn(e),Xn(t))}var Pr={ignore:"",grid:null,hotkey:"mod+shift+a",panelKey:"b",rulerKey:"r",guideKeys:{vertical:"v",horizontal:"h"},theme:"auto"};function oo(e={}){return{...Pr,...e}}var no=["script","style","link","meta","head","title","noscript","nextjs-portal","[data-nextjs-toast]","[data-nextjs-dialog-overlay]","#webpack-dev-server-client-overlay","vite-error-overlay","[data-align-ignore]"].join(", ");function ro(e){return e.ignore?`${no}, ${e.ignore}`:no}function ae(e){return String(Math.round(e*100)/100)}function Ir(e){let t=e.tagName.toLowerCase();e.id&&(t+=`#${e.id}`);let o=e.classList[0];return o&&(t+=`.${o}`),t.length>32?t.slice(0,31)+"\u2026":t}function Dt(e){let t=e.getBoundingClientRect();return{el:e,label:Ir(e),left:t.left,right:t.right,top:t.top,bottom:t.bottom,width:t.width,height:t.height,scale:Oe(e)}}function io(e,t){let o=(n,r)=>Math.abs(n-r)<.001;return o(e.scale.x,t.scale.x)&&o(e.scale.y,t.scale.y)?e.scale:{x:1,y:1}}function ao(e){if(e.parentElement)return e.parentElement;let t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}function Ve(e,t,o){let n=ro(o),r=document.elementFromPoint(e,t);for(;r?.shadowRoot;){let i=r.shadowRoot.elementFromPoint(e,t);if(!i||i===r)break;r=i}for(;r&&r.matches(n);)r=ao(r);return r&&r!==document.documentElement?Dt(r):null}var It=e=>parseFloat(e)||0;function ln(e){let t=getComputedStyle(e),o=(n,r,i,a)=>[It(n),It(r),It(i),It(a)];return{padding:o(t.paddingTop,t.paddingRight,t.paddingBottom,t.paddingLeft),border:o(t.borderTopWidth,t.borderRightWidth,t.borderBottomWidth,t.borderLeftWidth),margin:o(t.marginTop,t.marginRight,t.marginBottom,t.marginLeft)}}function Hr(e,t){return e.width*e.height>=t.width*t.height?[e,t]:[t,e]}function Dr(e,t){let o=io(e,t),n=t.left+t.width/2,r=t.top+t.height/2;return[{x1:e.left,y1:r,x2:t.left,y2:r,label:ae((t.left-e.left)/o.x),axis:"x"},{x1:t.right,y1:r,x2:e.right,y2:r,label:ae((e.right-t.right)/o.x),axis:"x"},{x1:n,y1:e.top,x2:n,y2:t.top,label:ae((t.top-e.top)/o.y),axis:"y"},{x1:n,y1:t.bottom,x2:n,y2:e.bottom,label:ae((e.bottom-t.bottom)/o.y),axis:"y"}]}function Ht(e,t,o,n,r){let i=n<t?t:n>o?o:null;return i===null?[]:[r==="x"?{x1:e,y1:i,x2:e,y2:n,label:"",axis:"y",extension:!0}:{x1:i,y1:e,x2:n,y2:e,label:"",axis:"x",extension:!0}]}function Gt(e,t){let o=[],n=io(e,t),r=e.left<t.right&&t.left<e.right,i=e.top<t.bottom&&t.top<e.bottom;if(r&&i){let[a,s]=Hr(e,t);return Dr(a,s)}if(!r){let[a,s]=e.right<=t.left?[e,t]:[t,e],u=i?(Math.max(e.top,t.top)+Math.min(e.bottom,t.bottom))/2:(e.top+e.height/2+t.top+t.height/2)/2;o.push({x1:a.right,y1:u,x2:s.left,y2:u,label:`${ae((s.left-a.right)/n.x)}`,axis:"x"}),o.push(...Ht(a.right,a.top,a.bottom,u,"x")),o.push(...Ht(s.left,s.top,s.bottom,u,"x"))}if(!i){let[a,s]=e.bottom<=t.top?[e,t]:[t,e],u=r?(Math.max(e.left,t.left)+Math.min(e.right,t.right))/2:(e.left+e.width/2+t.left+t.width/2)/2;o.push({x1:u,y1:a.bottom,x2:u,y2:s.top,label:`${ae((s.top-a.bottom)/n.y)}`,axis:"y"}),o.push(...Ht(a.bottom,a.left,a.right,u,"y")),o.push(...Ht(s.top,s.left,s.right,u,"y"))}return o}function Gr(e){if(e.length<2)return[...e];let t=n=>{let r=e.map(n);return Math.max(...r)-Math.min(...r)},o=t(n=>n.left+n.width/2)>=t(n=>n.top+n.height/2);return[...e].sort((n,r)=>o?n.left-r.left:n.top-r.top)}function cn(e){let t=Gr(e),o=[];for(let n=1;n<t.length;n++)o.push([t[n-1],t[n]]);return o}var Br=5,Or=8;function wt(e){return e.axis==="x"?e.at-scrollX:e.at-scrollY}function dn(e,t,o){let n=null,r=Br;for(let i of e){let a=Math.abs(wt(i)-(i.axis==="x"?t:o));a<=r&&(n=i,r=a)}return n}function so(e,t,o){if(o)return{at:e,what:""};let n=null,r=Or;for(let i of t){let a=Math.abs(i.at-e);a>r||(a<r-.001||n!==null&&i.rank<n.rank)&&(n=i,r=a)}return n?{at:n.at,what:n.what}:{at:e,what:""}}function lo(e,t,o=[]){let n=[];if(e){let r=t==="x"?e.left:e.top,i=t==="x"?e.right:e.bottom;n.push({at:r,what:`${e.label} ${t==="x"?"left":"top"}`,rank:0}),n.push({at:i,what:`${e.label} ${t==="x"?"right":"bottom"}`,rank:0}),n.push({at:(r+i)/2,what:`${e.label} centre`,rank:1})}for(let r of o)r.axis===t&&n.push({at:r.at,what:"guide",rank:2});return n}function un(e,t){let o=[];for(let n of["x","y"]){let r=t.filter(i=>i.axis===n).map(i=>({pos:i.pos,gap:n==="x"?i.pos<e.left?e.left-i.pos:i.pos>e.right?i.pos-e.right:-1:i.pos<e.top?e.top-i.pos:i.pos>e.bottom?i.pos-e.bottom:-1})).filter(i=>i.gap>=0).sort((i,a)=>i.gap-a.gap)[0];if(r)if(n==="x"){let i=e.top+e.height/2,a=r.pos<e.left?r.pos:e.right,s=r.pos<e.left?e.left:r.pos;o.push({x1:a,y1:i,x2:s,y2:i,label:ae(r.gap/e.scale.x),axis:"x"})}else{let i=e.left+e.width/2,a=r.pos<e.top?r.pos:e.bottom,s=r.pos<e.top?e.top:r.pos;o.push({x1:i,y1:a,x2:i,y2:s,label:ae(r.gap/e.scale.y),axis:"y"})}}return o}function co(e,t){let o=[];for(let n of["x","y"]){let r=e.filter(i=>i.axis===n).map(i=>i.pos).sort((i,a)=>i-a);for(let i=1;i<r.length;i++){let a=r[i-1],s=r[i],u=s-a;u<.01||(n==="x"?o.push({x1:a,y1:t.y,x2:s,y2:t.y,label:ae(u),axis:"x"}):o.push({x1:t.x,y1:a,x2:t.x,y2:s,label:ae(u),axis:"y"}))}}return o}var We=3;function zr(e,t){return e.x<t.x+t.w+We&&t.x<e.x+e.w+We&&e.y<t.y+t.h+We&&t.y<e.y+e.h+We}function uo(e,t,o=12){let n=(a,s)=>Math.min(Math.max(a,o),t.w-s-o),r=(a,s)=>Math.min(Math.max(a,o),t.h-s-o),i=[];for(let a of e){let s={...a,x:n(a.x,a.w),y:r(a.y,a.h)},u=!1;for(let S=0;S<16;S++){let v=i.find(c=>zr(c,s));if(!v)break;let N=s.axis==="x"?s.y:s.x;if(s.axis==="x"?s.y=r(u?v.y+v.h+We:v.y-s.h-We,s.h):s.x=n(u?v.x-s.w-We:v.x+v.w+We,s.w),(s.axis==="x"?s.y:s.x)===N){if(u)break;u=!0}}i.push(s)}return i}function po(e,t){let{columns:o,gutter:n,margin:r}=e;if(o<=0)return[];let i=e.maxWidth>0?Math.min(e.maxWidth,t):t,a=Math.max(0,(t-i)/2),u=(Math.max(0,i-r*2)-n*(o-1))/o;if(u<=0)return[];let S=[];for(let v=0;v<o;v+=1)S.push({left:a+r+v*(u+n),width:u});return S}function ho(e,t){return e*t>=8?e:0}function Fr(e){let t=/matrix(3d)?\(([^)]+)\)/.exec(e||"");if(!t)return{x:1,y:1};let o=t[2].split(",").map(s=>parseFloat(s)),[n,r,i,a]=t[1]?[o[0],o[1],o[4],o[5]]:[o[0],o[1],o[2],o[3]];return{x:Math.hypot(n??1,r??0)||1,y:Math.hypot(i??0,a??1)||1}}function Oe(e){let t=1,o=1;for(let n=e;n;n=ao(n)){let r=Fr(getComputedStyle(n).transform);t*=r.x,o*=r.y}return{x:t,y:o}}var Re=(e,t)=>({light:e,dark:t}),pn={accent:Re("oklch(0.693 0.161 265.2)","oklch(0.693 0.161 265.2)"),measure:Re("oklch(0.637 0.208 25.3)","oklch(0.711 0.166 22.2)"),surface:Re("oklch(1 0 0)","oklch(0.264 0 0)"),fg:Re("oklch(0.205 0 0)","oklch(0.97 0 0)"),muted:Re("oklch(0.556 0 0)","oklch(0.715 0 0)"),guide:Re("oklch(0.62 0.13 195)","oklch(0.75 0.13 195)"),rulerBg:Re("oklch(1 0 0 / 0.92)","oklch(0.235 0 0 / 0.92)"),rulerLine:Re("oklch(0.205 0 0 / 0.28)","oklch(0.97 0 0 / 0.28)"),pixelLine:Re("oklch(0.205 0 0 / 0.14)","oklch(0.97 0 0 / 0.14)")};function fo(e){return`light-dark(${e.light}, ${e.dark})`}var we=fo(Re("#fafafa","#1a1a1a"));function at(e,t=e){return fo(Re(`rgb(0 0 0 / ${t})`,`rgb(255 255 255 / ${e})`))}var mo=[0,.07,.08,.1,.12,.15,.2];function F(e){let t=mo[Math.max(0,Math.min(mo.length-1,e))];return t===0?we:at(t)}var x={primary:at(.9),secondary:at(.6),tertiary:at(.46,.55),disabled:at(.22,.26)},ue=at(.12),ze="0 2px 8px rgb(0 0 0 / 0.2), 0 4px 16px rgb(0 0 0 / 0.1)",Bt="0 4px 12px rgb(0 0 0 / 0.24), 0 12px 32px rgb(0 0 0 / 0.16)",ee=22,_e=36,B={tight:4,base:8,roomy:12,edge:16},z={exit:"160ms cubic-bezier(0.3, 0, 1, 1)",ui:"160ms cubic-bezier(0.2, 0, 0, 1)"},Wr='Inter, ui-sans-serif, system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif',D={title:13,body:12,tag:11,stack:Wr},Z={regular:400,medium:500,semibold:600},hn="__align_font",_r="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&display=swap";function go(){if(document.getElementById(hn))return;let e=document.createElement("link");e.id=hn,e.rel="stylesheet",e.href=_r,e.setAttribute("data-align-ignore",""),document.head.appendChild(e)}function bo(){document.getElementById(hn)?.remove()}function yo(e){let t=[`${Z.medium} ${D.body}px Inter`];Promise.all(t.map(o=>document.fonts.load(o))).then(e,e)}function fn(e){let t={};for(let o of Object.keys(pn))t[o]=e?pn[o].dark:pn[o].light;return t}var mn=null;function xo(e){mn=e==="auto"?null:e}function gn(){if(mn)return mn==="dark";let e=document.documentElement,t=getComputedStyle(e).colorScheme;if(/dark/.test(t)&&!/light/.test(t))return!0;if(/light/.test(t)&&!/dark/.test(t))return!1;for(let o of[document.body,e]){if(!o)continue;let n=Xr(getComputedStyle(o).backgroundColor);if(n!==null)return n<.5}return matchMedia("(prefers-color-scheme: dark)").matches}function Xr(e){let t=/^rgba?\(([^)]+)\)$/.exec(e.trim());if(!t)return null;let o=t[1].split(/[\s,/]+/).filter(Boolean).map(Number),[n,r,i,a=1]=o;return n===void 0||r===void 0||i===void 0||a<.5?null:(.2126*n+.7152*r+.0722*i)/255}function qe(e,t){return e.replace(/\)$/,` / ${t})`)}var Kr=`
`,Ie=16,Yr=`
.dock {
...
`,Eo="align-scrub";function oi(e){if(e.querySelector(`#${Eo}`))return;let t=document.createElement("style");t.id=Eo,t.textContent=ni,e.appendChild(t)}function So(e,t){oi(e);let o=t.min??0,n=t.max??9999,r=t.step??1,i=t.axis??"x",a=t.value,s=document.createElement("button");if(s.type="button",s.className="scrub",s.dataset.axis=i,s.setAttribute("aria-label",t.label),s.title=`${t.label}. Drag to change, click to type.`,t.glyph){let p=document.createElement("span");p.className="scrub-glyph",p.appendChild(ve(t.glyph,14)),s.appendChild(p)}else if(t.text){let p=document.createElement("span");p.className="scrub-text",p.textContent=t.text,s.appendChild(p)}let u=document.createElement("span");u.className="scrub-value",s.appendChild(u);function S(){u.textContent=$o(a),s.setAttribute("aria-valuenow",String(a))}function v(p,g){let _=Math.max(o,Math.min(n,p));_!==a&&(a=_,S(),t.onChange(a)),g||t.onCommit?.(a)}let N=null,c=!1,w=1;s.addEventListener("pointerdown",p=>{if(!(E||p.button!==0)){p.preventDefault(),p.stopPropagation();try{s.setPointerCapture(p.pointerId)}catch{}N={x:p.clientX,y:p.clientY,value:a},c=!1,w=(i==="x"?Oe(s).x:Oe(s).y)||1,s.setAttribute("data-scrubbing","")}}),s.addEventListener("pointermove",p=>{if(!N)return;let g=i==="x"?(p.clientX-N.x)/w:(p.clientY-N.y)/w;!c&&Math.abs(g)>Qr&&(c=!0),c&&v(ei(N.value,g,o,n,r),!0)});let C=p=>{if(N){try{s.releasePointerCapture(p.pointerId)}catch{}N=null,s.removeAttribute("data-scrubbing"),c&&t.onCommit?.(a)}};s.addEventListener("pointerup",C),s.addEventListener("pointercancel",C);let E=null;function W(){if(E)return;E=document.createElement("input"),E.className="scrub-input",E.type="text",E.value=$o(a),E.setAttribute("aria-label",`${t.label}, as a number`),u.style.display="none",s.appendChild(E),E.focus(),E.select();let p=g=>{if(E){if(g){let _=ti(E.value,o,n);_!==null&&v(_,!1)}E.remove(),E=null,u.style.display="",s.focus()}};E.addEventListener("keydown",g=>{g.stopPropagation(),g.key==="Enter"?(g.preventDefault(),p(!0)):g.key==="Escape"&&(g.preventDefault(),p(!1))}),E.addEventListener("blur",()=>p(!0)),E.addEventListener("pointerdown",g=>g.stopPropagation())}return s.addEventListener("click",p=>{if(p.stopPropagation(),c){c=!1;return}W()}),s.addEventListener("keydown",p=>{if(p.target!==s||p.altKey||p.metaKey||p.ctrlKey)return;let g=p.shiftKey?10:1;p.key==="ArrowUp"||p.key==="ArrowRight"?(p.preventDefault(),p.stopPropagation(),v(a+r*g,!1)):p.key==="ArrowDown"||p.key==="ArrowLeft"?(p.preventDefault(),p.stopPropagation(),v(a-r*g,!1)):p.key==="Enter"&&(p.preventDefault(),p.stopPropagation(),W())}),S(),{el:s,set(p){a=Math.max(o,Math.min(n,p)),S()},destroy(){E?.remove(),s.remove()}}}function Co(e,t=0,o=0){return Math.min(100,Math.max(...[e,t,o].map(n=>{let[r,i="0"]=String(n).toLowerCase().split("e");return Math.max(0,(r.split(".")[1]?.length??0)-Number(i))})))}function wn(e,t,o,n){let r=o??-1/0,i=n??1/0,a=Math.max(r,Math.min(i,e));if(a===r||a===i||!Number.isFinite(t)||t<=0)return a;let s=o??0,u=s+Math.round((a-s)/t)*t;return Math.max(r,Math.min(i,Number(u.toPrecision(14))))}var ri=.03125;function ii(e,t,o){let n=(e-t)/(o-t),r=Math.round(n*10)/10;return Math.abs(n-r)<=ri?t+r*(o-t):e}var ai=32,si=8,li=200;function To(e,t){let o=Math.max(0,e-ai);return t*si*Math.sqrt(Math.min(o/li,1))}function Ot(e,t,o){return o===t?0:(e-t)/(o-t)*100}function Mo(e,t,o){let n=Math.max(0,Math.min(1,e));return t+n*(o-t)}function ci(e,t,o,n,r,i=!1){if(e==="Home")return o;if(e==="End")return n;let a=["ArrowRight","ArrowUp","PageUp"].includes(e)?1:["ArrowLeft","ArrowDown","PageDown"].includes(e)?-1:0;if(!a)return;if(!(r>0)||n<=o)return o;let s=e.startsWith("Page")||i?10:1,u=(t-o)/r,S=o+(a>0?Math.floor(u+1e-9)+s:Math.ceil(u-1e-9)-s)*r;return Math.max(o,Math.min(n,Number(S.toPrecision(14))))}function di(e,t,o){let n=(t-e)/o;return n<=10&&Number.isFinite(n)&&n>1?Array.from({length:Math.round(n)-1},(r,i)=>(i+1)*o/(t-e)*100):Array.from({length:9},(r,i)=>(i+1)*10)}function Ao(e,t,o=0,n=0){let r=Co(t,o,n),i=Math.max(r,Math.min(4,Co(e)));return!Number.isFinite(t)||t<=0?i:wn(e,t,o,n)===e?r:i}function ui(e,t,o,n){return(o-t)/n<=10?Math.max(t,Math.min(o,t+Math.round((e-t)/n)*n)):ii(e,t,o)}var kn={stiffness:300,damping:25,mass:.8},pi={stiffness:220,damping:22,mass:1};function Ft(e,t,o,n,r){let i=(-r.stiffness*(e-o)-r.damping*t)/r.mass,a=t+i*n;return{x:e+a*n,v:a}}function Wt(e,t,o,n=.01){return Math.abs(e-o)<n&&Math.abs(t)<n}var hi=0,mi=.5,fi=.9,gi=.1,bi=3,yi=800,Lo=8,zt=3,xi=20,Ro=10,vn=12,wi=`
.sl {
  position: relative;
  height: ${_e}px;
  overflow: hidden;
...
.sl[data-awake] .sl-handle { opacity: ${mi}; scale: 1 1; }
.sl[data-dragging] .sl-handle { opacity: ${fi}; }
.sl[data-dodge] .sl-handle { opacity: ${gi}; scale: 1 0.75; }
...
.sl-label { left: ${Ro}px; color: ${x.secondary}; pointer-events: none; }
.sl-value {
  right: ${vn}px;
  color: ${x.secondary};
...
`,No="align-slider";function vi(e){if(e.querySelector(`#${No}`))return;let t=document.createElement("style");t.id=No,t.textContent=wi,e.appendChild(t)}function _t(e,t){vi(e);let o=t.min??0,n=t.max??1,r=t.step??.01,i=t.value,a=document.createElement("div");a.className="sl",a.tabIndex=0,a.setAttribute("role","slider"),a.setAttribute("aria-label",t.label),a.setAttribute("aria-valuemin",String(o)),a.setAttribute("aria-valuemax",String(n));let s=document.createElement("div");s.className="sl-fill";let u=document.createElement("div");u.className="sl-marks";for(let h of di(o,n,r)){let A=document.createElement("div");A.className="sl-mark",A.style.left=`${h}%`,u.appendChild(A)}let S=document.createElement("div");S.className="sl-handle";let v=document.createElement("span");v.className="sl-label",v.textContent=t.label;let N=document.createElement("span");N.className="sl-value",a.append(u,s,S,v,N);let c=Ot(i,o,n),w=0,C=null,E=0,W=0;function p(){return a.offsetWidth}function g(){s.style.transform=`scaleX(${c/100})`;let h=p(),A=c/100*h,K=Math.max(zt,Math.min(h-zt,A))-zt/2;S.style.transform=`translate(${K}px, -50%)`;let ne=!1;if(h>0){let Se=Ro+v.offsetWidth+Lo,ge=h-vn-N.offsetWidth-Lo;ne=A<Se||A>ge}a.toggleAttribute("data-dodge",ne)}function _(){let h=Ao(i,r,o,n);N.textContent=t.unit?`${i.toFixed(h)}${t.unit}`:i.toFixed(h),a.setAttribute("aria-valuenow",String(i)),a.setAttribute("aria-valuetext",N.textContent)}function X(){E&&cancelAnimationFrame(E),E=0,C=null,w=0}function j(){return typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion: reduce)").matches}function le(h,A=kn){if(j()){X(),c=h,g();return}if(C=h,W=performance.now(),E)return;let K=ne=>{let Se=Math.min((ne-W)/1e3,.03333333333333333);if(W=ne,C===null){E=0;return}let ge=Ft(c,w,C,Se,A);if(c=ge.x,w=ge.v,g(),Wt(c,w,C)){c=C,w=0,C=null,E=0,g();return}E=requestAnimationFrame(K)};E=requestAnimationFrame(K)}function ie(h,A){let K=wn(h,r,o,n),ne=K!==i;i=K,_(),A?le(Ot(i,o,n)):(X(),c=Ot(i,o,n),g()),ne&&t.onChange(i)}let Q=null,q=!0,b=null,O=1,re=0,I=0;function U(h){if(re=h,h===0){a.style.width="",a.style.transform="";return}a.style.width=`calc(100% + ${Math.abs(h)}px)`,a.style.transform=h<0?`translateX(${h}px)`:""}function R(){if(re===0)return;if(j()){U(0),a.style.width="",a.style.transform="";return}let h=0,A=performance.now(),K=ne=>{let Se=Math.min((ne-A)/1e3,.03333333333333333);A=ne;let ge=Ft(re,h,0,Se,pi);if(h=ge.v,U(ge.x),Wt(ge.x,h,0,.05)){U(0),a.style.width="",a.style.transform="",I=0;return}I=requestAnimationFrame(K)};I=requestAnimationFrame(K)}function Y(h){if(!b)return 0;let A=p();return A<=0?0:(h-b.left)/O/A}let te=h=>{if(!(f||h.button!==0)){h.preventDefault();try{a.setPointerCapture(h.pointerId)}catch{}Q={x:h.clientX,y:h.clientY},q=!0,b=a.getBoundingClientRect(),O=Oe(a).x||1,a.setAttribute("data-awake","")}},l=h=>{if(!Q)return;let A=h.clientX-Q.x,K=h.clientY-Q.y;q&&Math.hypot(A,K)>bi&&(q=!1,a.setAttribute("data-dragging","")),!(q||!b)&&(j()||(h.clientX<b.left?U(To(b.left-h.clientX,-1)):h.clientX>b.right?U(To(h.clientX-b.right,1)):re!==0&&U(0)),X(),ie(Mo(Y(h.clientX),o,n),!1))},T=h=>{Q&&(q&&ie(ui(Mo(Y(h.clientX),o,n),o,n,r),!0),t.onCommit?.(i),R(),Q=null,a.removeAttribute("data-dragging"),P||a.removeAttribute("data-awake"))},y=()=>{Q&&(U(0),a.style.width="",a.style.transform="",Q=null,a.removeAttribute("data-dragging"),P||a.removeAttribute("data-awake"))},P=!1,H=()=>{P=!0,a.setAttribute("data-awake","")},d=()=>{P=!1,Q||a.removeAttribute("data-awake")},f=null,k=!1,G=0;function L(){if(f)return;f=document.createElement("input"),f.className="sl-input",f.type="text",f.setAttribute("aria-label",`${t.label} value`),f.value=i.toFixed(Ao(i,r,o,n)),N.style.display="none",a.appendChild(f),f.focus(),f.select();let h=A=>{if(f){if(A){let K=parseFloat(f.value);Number.isFinite(K)&&(ie(Math.max(o,Math.min(n,K)),!0),t.onCommit?.(i))}f.remove(),f=null,N.style.display="",$(!1),a.focus()}};f.addEventListener("keydown",A=>{A.stopPropagation(),A.key==="Enter"?(A.preventDefault(),h(!0)):A.key==="Escape"&&(A.preventDefault(),h(!1))}),f.addEventListener("blur",()=>h(!0)),f.addEventListener("pointerdown",A=>A.stopPropagation())}function $(h){k=h,N.toggleAttribute("data-editable",h)}N.addEventListener("pointerenter",()=>{f||Q||(G=window.setTimeout(()=>$(!0),yi))}),N.addEventListener("pointerleave",()=>{clearTimeout(G),f||$(!1)}),N.addEventListener("pointerdown",h=>{k&&(h.stopPropagation(),h.preventDefault(),L())});let M=h=>{if(h.target!==a||h.altKey||h.metaKey||h.ctrlKey)return;let A=ci(h.key,i,o,n,r,h.shiftKey);if(A===void 0){if(h.key!=="Enter")return;h.preventDefault(),h.stopPropagation(),$(!0),L();return}h.preventDefault(),h.stopPropagation(),ie(A,!1),t.onCommit?.(i)};return a.addEventListener("pointerdown",te),a.addEventListener("pointermove",l),a.addEventListener("pointerup",T),a.addEventListener("pointercancel",y),a.addEventListener("lostpointercapture",y),a.addEventListener("pointerenter",H),a.addEventListener("pointerleave",d),a.addEventListener("keydown",M),_(),requestAnimationFrame(g),{el:a,set(h){i=wn(h,r,o,n),_(),X(),c=Ot(i,o,n),g()},destroy(){X(),I&&cancelAnimationFrame(I),clearTimeout(G),a.remove()}}}function $e(e,t){return getComputedStyle(e).getPropertyValue(t).trim()}function ki(e,t){let o=parseFloat(e);if(e.endsWith("px")&&Number.isFinite(o)){let r=sn(o,t)[0];if(r)return r}return yt(e)?Pt(e,t)[0]??null:null}function $i(e){if(e.length===0)return"";let t=new Map;for(let n of e){let r=t.get(n.selector)??[];r.push(n),t.set(n.selector,r)}let o=["These changes were made live in the browser and are not in the source yet.","Apply them, preferring the named token wherever one is given.",""];for(let[n,r]of t){o.push(`${n} {`);for(let i of r){let a=i.token?`var(${i.token})`:i.to,s=i.token?`  /* ${i.to}, was ${i.from} */`:`  /* was ${i.from} */`;o.push(`  ${i.prop}: ${a};${s}`)}o.push("}","")}return o.join(`
`).trimEnd()}function Po(){let e=new Map,t=!1;function o(r){let i=e.get(r);if(i)return i;let a=new Map;return e.set(r,a),a}function n(r,i,a){let s=r.style;a.inline?s.setProperty(i,a.inline):s.removeProperty(i)}return{get armed(){return t},arm(){t=!0},disarm(){let r=this.revertAll();return t=!1,r},set(r,i,a){if(!t)return;let s=o(r);s.has(i)||s.set(i,{inline:r.style.getPropertyValue(i),computed:$e(r,i)}),r.style.setProperty(i,a)},revert(r,i){let a=e.get(r),s=a?.get(i);!a||!s||(n(r,i,s),a.delete(i),a.size===0&&e.delete(r))},revertAll(){let r=0;for(let[i,a]of e)for(let[s,u]of a)n(i,s,u),r+=1;return e.clear(),r},touched(r,i){return e.get(r)?.has(i)??!1},touchedProps(r){return[...e.get(r)?.keys()??[]].sort()},changes(){let r=[];for(let[i,a]of e)for(let[s,u]of a)r.push({el:i,prop:s,from:u.computed,to:$e(i,s)});return r},asPrompt(){let r=[];for(let[i,a]of e){let s=Rt(i),u=xt(i);for(let[S,v]of a){let N=$e(i,S);N!==v.computed&&r.push({selector:u,prop:S,from:v.computed,to:N,token:ki(N,s)})}}return $i(r)}}}var he=(e,t=0,o=1)=>Math.max(t,Math.min(o,e)),$n=e=>(e%360+360)%360,Xt=(e,t)=>e.map(o=>o.reduce((n,r,i)=>n+r*t[i],0)),Ei=e=>Math.abs(e)<=.04045?e/12.92:Math.sign(e)*((Math.abs(e)+.055)/1.055)**2.4,Si=e=>Math.abs(e)<=.0031308?12.92*e:Math.sign(e)*(1.055*Math.abs(e)**.4166666666666667-.055),Ci=[[.4123907993,.3575843394,.1804807884],[.2126390059,.7151686788,.0721923154],[.0193308187,.1191947798,.9505321522]],Ti=[[.4865709486,.2656676932,.1982172852],[.2289745641,.6917385218,.0792869141],[0,.0451133819,1.0439443689]],Mi=[[3.2409699419,-1.5373831776,-.4986107603],[-.9692436363,1.8759675015,.0415550574],[.0556300797,-.2039769589,1.0569715142]],Ai=[[2.4934969119,-.9313836179,-.4027107845],[-.8294889696,1.7626640603,.0236246858],[.0358458302,-.0761723893,.956884524]],Li=[[.819022438,.3619062601,-.1288737815],[.0329836539,.9292868616,.0361446664],[.0481771894,.2642395318,.6335478285]],Ni=[[1.2268798734,-.5578149966,.2813910502],[-.0405757626,1.1122868294,-.0717110667],[-.0763729497,-.421493324,1.5869240244]];function St(e,t=1,o="srgb"){let n=Xt(o==="p3"?Ti:Ci,e.map(Ei)),[r,i,a]=Xt(Li,n).map(Math.cbrt),s=.2104542553*r+.793617785*i-.0040720468*a,u=1.9779984951*r-2.428592205*i+.4505937099*a,S=.0259040371*r+.7827717662*i-.808675766*a,v=Math.hypot(u,S);return{l:he(s),c:v<1e-7?0:v,h:v<1e-7?0:$n(Math.atan2(S,u)*180/Math.PI),a:he(t)}}function Ct(e,t="srgb"){let o=e.c*Math.cos(e.h*Math.PI/180),n=e.c*Math.sin(e.h*Math.PI/180),r=[(e.l+.3963377774*o+.2158037573*n)**3,(e.l-.1055613458*o-.0638541728*n)**3,(e.l-.0894841775*o-1.291485548*n)**3];return Xt(t==="p3"?Ai:Mi,Xt(Ni,r)).map(Si)}function Io(e,t="srgb"){return Ct(e,t).every(o=>o>=-1e-5&&o<=1.00001)}function Kt(e,t="srgb"){if(Io(e,t))return e;let o=0,n=e.c;for(let r=0;r<20;r++){let i=(o+n)/2;Io({...e,c:i},t)?o=i:n=i}return{...e,c:o}}function Je(e,t,o="srgb"){return e<=0||e>=1?0:Kt({l:e,c:.5,h:t,a:1},o).c}function Qe(e){let t=e.trim();return/^oklch\(/i.test(t)?"oklch":/^color\(display-p3\s/i.test(t)?"p3":"hex"}var Et=(e,t=4)=>Number(e.toFixed(t));function Ke(e,t){let o=e.a<1?` / ${Et(e.a)}`:"";if(t==="oklch")return`oklch(${Et(e.l)} ${Et(e.c)} ${Et(e.h,2)}${o})`;let n=t==="p3"?"p3":"srgb",r=Ct(Kt(e,n),n);if(t==="p3")return`color(display-p3 ${r.map(a=>Et(he(a),5)).join(" ")}${o})`;let i=r.map(a=>Math.round(he(a)*255));return e.a<1&&i.push(Math.round(e.a*255)),"#"+i.map(a=>a.toString(16).padStart(2,"0")).join("")}var Ri=/^[+-]?(?:\d+\.?\d*|\.\d+)(?:e[+-]?\d+)?(%|deg|grad|rad|turn)?$/i;function Xe(e,t=1,o=!1){let n=e.match(Ri);if(!n)return null;let r=parseFloat(e);if(!Number.isFinite(r))return null;let i=n[1]?.toLowerCase();return o?i==="rad"?r*180/Math.PI:i==="turn"?r*360:i==="grad"?r*.9:!i||i==="deg"?r:null:i==="%"?r*t/100:i?null:r}function Fe(e){let t=e.trim().toLowerCase();if(t==="transparent")return{l:0,c:0,h:0,a:0};if(/^#(?:[\da-f]{3,4}|[\da-f]{6}|[\da-f]{8})$/.test(t)){let c=t.slice(1);c.length<=4&&(c=[...c].map(C=>C+C).join(""));let w=c.match(/../g).map(C=>parseInt(C,16)/255);return St(w.slice(0,3),w[3]??1)}let o=t.match(/^(oklch|rgb|rgba|hsl|hsla|color)\(([^()]*)\)$/);if(!o)return null;let n=o[1],r=o[2].trim(),i=n==="color";if(i){if(!r.startsWith("display-p3 "))return null;r=r.slice(11).trim()}let a=r.includes(",");if(a&&(i||n==="oklch"||r.includes("/")))return null;let s=a?r.split(",").map(c=>c.trim()):r.split(/\s*\/\s*/);if(!a&&s.length>2)return null;let u=a?s.slice(0,3):s[0].split(/\s+/);if(u.length!==3||a&&s.length!==3&&s.length!==4||a&&n.startsWith("rgb")&&u.some(c=>c.endsWith("%"))&&!u.every(c=>c.endsWith("%")))return null;let S=a?s[3]:s[1],v=S===void 0?1:Xe(S);if(v===null)return null;if(n==="oklch"){let c=Xe(u[0]),w=Xe(u[1],.4),C=Xe(u[2],1,!0);return c===null||w===null||C===null?null:{l:he(c),c:Math.max(0,w),h:$n(C),a:he(v)}}if(n.startsWith("hsl")){let c=Xe(u[0],1,!0),w=Xe(u[1]),C=Xe(u[2]);if(c===null||w===null||C===null||!u[1].endsWith("%")||!u[2].endsWith("%"))return null;let E=he(w),W=he(C),p=E*Math.min(W,1-W),g=_=>{let X=(_+$n(c)/30)%12;return W-p*Math.max(-1,Math.min(X-3,9-X,1))};return St([g(0),g(8),g(4)],v)}let N=u.map(c=>Xe(c,i?1:255));return N.some(c=>c===null)?null:St(N.map(c=>i?c:he(c/255)),v,i?"p3":"srgb")}function lt(e,t=!1){return Ke(t?{...e,a:1}:e,"oklch")}var Ho=148,Pi=14,Yt=12,Do=`
.pick {
  position: fixed;
  z-index: 3;
  width: 248px;
...
`;function jo(e){let t=document.createElement("style");t.textContent=Zi,e.appendChild(t);let o=document.createElement("div");o.className="picker",e.appendChild(o);let n=document.createElement("div");n.className="swatch";let r=document.createElement("div");r.className="hint";function i(a){n.style.background=a;let s=Yo(a).map(({label:u,value:S})=>{let v=document.createElement("button");v.type="button";let N=document.createElement("span");N.className="k",N.textContent=u;let c=document.createElement("span");return c.className="v",c.textContent=S,v.append(N,c),v.addEventListener("click",w=>{w.stopPropagation(),navigator.clipboard?.writeText(S).then(()=>{r.textContent=`copied ${u}`},()=>{r.textContent="clipboard refused"})}),v});r.textContent="click a row to copy",o.replaceChildren(n,...s,r),o.setAttribute("data-open","")}return{async open(){let a=window.EyeDropper;if(!a){o.replaceChildren(Object.assign(document.createElement("div"),{className:"hint",textContent:"this browser has no eyedropper"})),o.setAttribute("data-open","");return}try{let{sRGBHex:s}=await new a().open();i(s)}catch{}},close(){let a=o.hasAttribute("data-open");return o.removeAttribute("data-open"),a},destroy(){o.remove(),t.remove()}}}var Tn="__align_freeze",Ji=`
[data-align-frozen] *:not([data-align-ignore]):not([data-align-ignore] *) {
  animation-play-state: paused !important;
}
`,Mn=!1,Zt=[],Jt=[];function Uo(e){let t=e;for(;t;){if(t instanceof Element&&t.hasAttribute("data-align-ignore"))return!0;let o=t.getRootNode();if(t=o instanceof ShadowRoot?o.host:t.parentNode??null,t===document)return!1}return!1}function Qt(){return Mn}function An(e){if(e!==Mn){if(Mn=e,!e){document.documentElement.removeAttribute("data-align-frozen"),document.getElementById(Tn)?.remove();for(let t of Zt)try{t.play()}catch{}for(let t of Jt)t.play().catch(()=>{});Zt=[],Jt=[];return}if(!document.getElementById(Tn)){let t=document.createElement("style");t.id=Tn,t.textContent=Ji,t.setAttribute("data-align-ignore",""),document.head.appendChild(t)}document.documentElement.setAttribute("data-align-frozen",""),Zt=[];try{for(let t of document.getAnimations()){if(t.playState!=="running")continue;let o=t.effect?.target??null;Uo(o)||(t.pause(),Zt.push(t))}}catch{}Jt=[];for(let t of Array.from(document.querySelectorAll("video")))t.paused||Uo(t)||(t.pause(),Jt.push(t))}}var Ln="__align_xray",Qi=`
...
`;function Nn(e){let t=document.documentElement;if(!e){t.removeAttribute("data-align-xray"),document.getElementById(Ln)?.remove();return}if(!document.getElementById(Ln)){let o=document.createElement("style");o.id=Ln,o.textContent=Qi,o.setAttribute("data-align-ignore",""),document.head.appendChild(o)}t.setAttribute("data-align-xray","")}var Rn="align-ui";function Vo(e){try{return localStorage.getItem(e)}catch{return null}}function qo(e,t){try{localStorage.setItem(e,t)}catch{}}function Zo(e){let t="/";try{t=location.pathname||"/"}catch{}return`${Rn}:${e}::${t}`}function ea(e){if(typeof e!="object"||e===null)return!1;let t=e;return(t.axis==="x"||t.axis==="y")&&typeof t.at=="number"&&Number.isFinite(t.at)}function Jo(){let e=Vo(Zo("guides"));if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.filter(ea).map(o=>({id:0,axis:o.axis,at:o.at,locked:o.locked===!0,pinned:o.pinned===!0,caught:typeof o.caught=="string"?o.caught:""})):[]}catch{return[]}}function Qo(e){qo(Zo("guides"),JSON.stringify(e.map(t=>({axis:t.axis,at:t.at,locked:t.locked,pinned:t.pinned,caught:t.caught}))))}function en(e){return Vo(`${Rn}:${e}`)==="1"}function tn(e,t){qo(`${Rn}:${e}`,t?"1":"0")}var ke,oe=null,Ee=null,He=null,bt=null,je=null,tt=Po(),ot=!1,ht=en("grid"),mt=en("pixels"),fe=null,J=[],on=0,rt=en("rulers"),de=[],sr=1,er=!1,De=null,dt=!1,ut=!1,Pn,nt=vo();function ta(){return de.map(e=>({...e}))}function ft(e=""){nt.push(ta(),e)}function tr(){return de.find(e=>e.id===De)??null}function Ye(e){de=e,Qo(de)}var be=null,Pe=null,Ne=null,na=3,pt=22;function lr(e,t){return rt?t<pt&&e>=pt?"y":e<pt&&t>=pt?"x":null:null}function Hn(e){return e.ctrlKey||e.metaKey}function cr(e,t,o,n){let r=Ve(t,o,ke),i=e.axis==="x"?t:o,a=de.filter(u=>u.id!==e.id).map(u=>({axis:u.axis,at:Mt(u).pos})),s=so(i,lo(r,e.axis,a),n);e.at=s.at+(e.axis==="x"?scrollX:scrollY),e.caught=s.what}function dr(e,t,o,n){let r={id:sr++,axis:e,at:0,locked:!1,caught:"",pinned:!1};cr(r,t,o,n);let i=de.find(a=>a.axis===r.axis&&Math.abs(a.at-r.at)<.5);return i?(De=i.id,i):(ft(),Ye([...de,r]),De=r.id,r)}function ur(e){e.pinned||(ft(),Ye(de.filter(t=>t.id!==e.id)),Pe?.id===e.id&&(Pe=null),be?.id===e.id&&(be=null))}function oa(e){let t=ke.hotkey.toLowerCase().split("+"),o=t[t.length-1];return e.key.toLowerCase()!==o||t.includes("shift")!==e.shiftKey||t.includes("alt")!==e.altKey?!1:(t.includes("mod")||t.includes("ctrl")||t.includes("cmd"))===(e.metaKey||e.ctrlKey)}function Mt(e){return{axis:e.axis,pos:e.axis==="x"?e.at-scrollX:e.at-scrollY}}function Dn(){return J.length>=2?J[J.length-2]:void 0}function Gn(){if(J.length<2)return[];let e=[];for(let[t,o]of cn(J))for(let n of Gt(t,o)){if(n.extension||!n.label)continue;let r=jn(t.el,o.el,parseFloat(n.label),n.axis);e.push({px:r.px,detail:Un(r)})}return e}function ye(e){let t=J[J.length-1],o=fe&&J.some(c=>c.el===fe.el),n=de.map(Mt),r=!be&&Pe?Pe:null,i=de.filter(c=>c.locked||c.id===r?.id),a=!r&&o?fe.el:null,s=r??a,u=r?Mt(r):null,S=[],v=(c,w)=>{for(let C of c)S.push(s&&!w?{...C,faded:!0}:C)},N=c=>!u||c.axis!==u.axis?!1:(c.axis==="x"?[c.x1,c.x2]:[c.y1,c.y2]).some(C=>Math.abs(C-u.pos)<.5);for(let[c,w]of cn(J))v(Gt(c,w),c.el===a||w.el===a);t&&fe&&!o&&!r&&v(Gt(t,fe),!0);for(let c of i)for(let w of J)v(un(w,[Mt(c)]),c.id===r?.id||w.el===a);fe&&!o&&!r&&de.length&&v(un(fe,n),!0);for(let c of co(i.map(Mt),{x:innerWidth/2,y:innerHeight/2}))v([c],N(c));oe?.update({hover:fe,pinned:J,rulers:rt,hidden:dt,dimLock:ut,grid:ht&&ke.grid?ke.grid:null,pixels:mt,guides:de,liveGuide:be??Pe,activeGuide:De,lines:S,...e?{cursor:e}:{}}),He?.update(J.length,{edit:tt.armed,rulers:rt,xray:ot,grid:ht,pixels:mt,freeze:Qt(),type:Ee?.showsType()??!1,hide:dt,canCopy:J.length>0,canUndo:nt.depth()>0,panel:Ee?.isOpen()??!1})}function ra(){let e=Ee?.asText()??"";if(!e)return;let t=n=>He?.acknowledge("copy",n),o=navigator.clipboard?.writeText(e);o?o.then(()=>t(!0),()=>t(!1)):t(!1)}function ia(e,t){return e.length===t.length&&e.every((o,n)=>{let r=t[n];return o.id===r.id&&o.axis===r.axis&&o.at===r.at&&o.locked===r.locked&&o.pinned===r.pinned})}function aa(){for(;nt.depth()>0&&ia(nt.peek(),de);)nt.pop();let e=nt.pop();e&&(Ye(e),Pe=null,be=null,Ne=null,e.some(t=>t.id===De)||(De=null))}function Me(e){switch(e){case"rulers":rt=!rt,tn("rulers",rt);break;case"xray":ot=!ot,Nn(ot);break;case"grid":ht=!ht,tn("grid",ht);break;case"pixels":mt=!mt,tn("pixels",mt);break;case"freeze":An(!Qt());break;case"type":Ee?.toggleType();break;case"panel":Ee?.toggle();break;case"hide":dt=!dt,Ee?.setHidden(dt),dt&&bt?.close();break;case"copy":ra();break;case"pick":bt?.open();break;case"edit":if(tt.armed){let t=tt.disarm();He?.acknowledge("edit",t>=0)}else tt.arm();je?.setArmed(tt.armed),J.length&&ye();break;case"undo":aa();break}ye()}var nn=null;function pr(e){if(nn={x:e.clientX,y:e.clientY},be){Ne&&Math.hypot(e.clientX-Ne.x,e.clientY-Ne.y)>na&&(Ne=null),!Ne&&!be.pinned&&(cr(be,e.clientX,e.clientY,Hn(e)),Ye([...de])),ye({x:e.clientX,y:e.clientY});return}Pe=dn(de,e.clientX,e.clientY),fe=Ve(e.clientX,e.clientY,ke),ye({x:e.clientX,y:e.clientY})}function hr(e){be&&(Ne?(be.locked=!be.locked,De=be.id,Ye([...de])):(lr(e.clientX,e.clientY)||e.clientX<pt||e.clientY<pt)&&ur(be),Ne=null,be=null,ye({x:e.clientX,y:e.clientY}))}function At(e){let t=oe?.root.host;return t?(e.composedPath?.()??[]).includes(t):!1}function mr(e){At(e)&&fr(!0)}function rn(){fr(!1)}function fr(e){if(clearTimeout(Pn),e){if(ut)return;ut=!0,ye();return}ut&&(Pn=setTimeout(()=>{ut=!1,ye()},200))}function gr(e){if(e.button!==0||At(e))return;let t=Ve(e.clientX,e.clientY,ke);if(!t)return;let o=lr(e.clientX,e.clientY);if(o){gt(e),Ne=null,be=dr(o,e.clientX,e.clientY,Hn(e)),ye({x:e.clientX,y:e.clientY});return}let n=dn(de,e.clientX,e.clientY);if(n){gt(e),ft(),De=n.id,be=n,Ne={x:e.clientX,y:e.clientY},ye({x:e.clientX,y:e.clientY});return}gt(e),He?.closeHelp(),J=[t],fe=t,Ee?.show(t,Gn(),Dn()),je?.show(t.el),ye({x:e.clientX,y:e.clientY})}function br(e){if(At(e))return;let t=Ve(e.clientX,e.clientY,ke);if(!t)return;gt(e),He?.closeHelp();let o=J.findIndex(r=>r.el===t.el);J=o>=0?J.filter((r,i)=>i!==o):[...J,t],fe=t;let n=J[J.length-1];n?Ee?.show(n,Gn(),Dn()):Ee?.hide(),je?.show(n?.el??null),ye({x:e.clientX,y:e.clientY})}function yr(e){At(e)||Ve(e.clientX,e.clientY,ke)&&gt(e)}function xr(e){At(e)||Ve(e.clientX,e.clientY,ke)&&gt(e)}function gt(e){e.preventDefault(),e.stopPropagation()}function nr(e,t){return e.left===t.left&&e.top===t.top&&e.width===t.width&&e.height===t.height}var or=0,rr=0;function wr(){on=requestAnimationFrame(wr);let t=J.filter(s=>s.el.isConnected).map(s=>Dt(s.el)),o=fe&&fe.el.isConnected?Dt(fe.el):null;if(!(scrollX!==or||scrollY!==rr||t.length!==J.length||t.some((s,u)=>!nr(s,J[u]))||fe===null!=(o===null)||fe!==null&&o!==null&&!nr(fe,o)))return;or=scrollX,rr=scrollY,J=t,fe=o;let i=J[J.length-1],a=sa();a!==ir&&(ir=a,i?Ee?.show(i,Gn(),Dn()):Ee?.hide(),je?.show(i?.el??null)),ye()}var ir="";function sa(){let e=J[0];return e?J.map(t=>[t.label,Math.round(t.width*100),Math.round(t.height*100),Math.round((t.left-e.left)*100),Math.round((t.top-e.top)*100)].join(",")).join(";"):""}function vr(){oe?.resize()}function la(){er||(er=!0,de=Jo().map(e=>({...e,id:sr++}))),!oe&&(go(),oe=Ko(),Ee=wo(oe.root),He=ko(oe.root,Me),je=_o(oe.root,tt),bt=jo(oe.root),He.update(0,{rulers:rt,xray:ot,grid:ht,pixels:mt,freeze:Qt(),type:!1,panel:!1,hide:!1,edit:!1,canCopy:!1,canUndo:!1}),addEventListener("pointerdown",mr,{capture:!0}),addEventListener("pointerup",rn,{capture:!0}),addEventListener("pointercancel",rn,{capture:!0}),addEventListener("mousemove",pr),addEventListener("mousedown",gr,{capture:!0}),addEventListener("mouseup",hr,{capture:!0}),addEventListener("click",yr,{capture:!0}),addEventListener("auxclick",xr,{capture:!0}),addEventListener("contextmenu",br,{capture:!0}),addEventListener("resize",vr),on=requestAnimationFrame(wr),ye())}function In(){removeEventListener("mousemove",pr),removeEventListener("mousedown",gr,{capture:!0}),removeEventListener("mouseup",hr,{capture:!0}),removeEventListener("click",yr,{capture:!0}),removeEventListener("auxclick",xr,{capture:!0}),removeEventListener("contextmenu",br,{capture:!0}),removeEventListener("pointerdown",mr,{capture:!0}),removeEventListener("pointerup",rn,{capture:!0}),removeEventListener("pointercancel",rn,{capture:!0}),removeEventListener("resize",vr),clearTimeout(Pn),ut=!1,cancelAnimationFrame(on),on=0,He?.destroy(),je?.destroy(),je=null,bt?.destroy(),bt=null,ot&&(ot=!1,Nn(!1)),An(!1),tt.disarm(),He=null,Ee?.destroy(),Ee=null,oe?.destroy(),oe=null,bo(),fe=null,J=[],be=null,Ne=null,Pe=null}function ca(e){let t=e.composedPath?.()[0]??e.target;return!t||typeof t!="object"||!("tagName"in t)?!1:t.isContentEditable?!0:t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"}function ar(e){if(oa(e))e.preventDefault(),oe?In():la();else if(!ca(e)){if(oe&&nn&&(e.key.toLowerCase()===ke.guideKeys.vertical||e.key.toLowerCase()===ke.guideKeys.horizontal)){e.preventDefault();let t=e.key.toLowerCase()===ke.guideKeys.vertical?"x":"y";dr(t,nn.x,nn.y,Hn(e)),ye()}else if(oe&&(e.key==="Delete"||e.key==="Backspace"))e.preventDefault(),e.shiftKey?(de.some(t=>!t.pinned)&&ft(),Ye(de.filter(t=>t.pinned)),Pe=null,be=null,Ne=null,de.some(t=>t.id===De)||(De=null)):Pe&&ur(Pe),ye();else if(oe&&e.key.startsWith("Arrow")){let t=tr(),o=e.key==="ArrowLeft"||e.key==="ArrowRight"?"x":"y";if(!t||t.axis!==o||(e.preventDefault(),t.pinned))return;ft(`nudge:${t.id}`);let n=e.shiftKey?10:1;t.at+=e.key==="ArrowLeft"||e.key==="ArrowUp"?-n:n,t.caught="",Ye([...de]),ye()}else if(oe&&e.key.toLowerCase()==="g"){e.preventDefault(),Me("grid");return}else if(oe&&e.key.toLowerCase()==="k"){e.preventDefault(),Me("pixels");return}else if(oe&&e.key==="\\"){e.preventDefault(),Me("hide");return}else if(oe&&e.key.toLowerCase()==="e"){e.preventDefault(),Me("edit");return}else if(oe&&e.key.toLowerCase()==="f"){e.preventDefault(),Me("freeze");return}else if(oe&&e.key.toLowerCase()==="x"){e.preventDefault(),Me("xray");return}else if(oe&&e.key.toLowerCase()==="p"){e.preventDefault(),Me("pick");return}else if(oe&&e.key.toLowerCase()==="t"){e.preventDefault(),Me("type");return}else if(oe&&e.key.toLowerCase()==="c"){e.preventDefault(),Me("copy");return}else if(oe&&e.key.toLowerCase()==="l"){let t=tr();if(!t)return;e.preventDefault(),ft(),t.pinned=!t.pinned,Ye([...de]),ye()}else if(oe&&(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){if(nt.depth()===0)return;e.preventDefault(),Me("undo");return}else if(oe&&e.key.toLowerCase()===ke.rulerKey){e.preventDefault(),Me("rulers");return}else if(oe&&e.key.toLowerCase()===ke.panelKey){e.preventDefault(),Me("panel");return}else if(e.key==="Escape"&&oe){if(bt?.close()||He?.closeHelp())return;J.length?(J=[],Ee?.hide(),je?.show(null),ye()):In()}}}function vs(e={}){if(typeof window>"u"||window.__align)return;window.__align=!0,ke=oo(e),xo(ke.theme),addEventListener("keydown",ar,{capture:!0});let t=import.meta.hot;t&&t.dispose(()=>{In(),removeEventListener("keydown",ar,{capture:!0}),delete window.__align})}export{vs as initAlign};
